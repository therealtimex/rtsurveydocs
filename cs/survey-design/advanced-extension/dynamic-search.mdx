---
description: Dynamické vyhledávání načítá volby ze vzdáleného API v reálném čase při
  psaní enumerátora, umožňující velké nebo často aktualizované datové sady.
icon: manage_search
