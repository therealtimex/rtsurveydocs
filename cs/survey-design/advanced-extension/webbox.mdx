---
description: Webbox vkládá externí webovou stránku do průzkumu jako modální iframe,
  což umožňuje enumerátorům prohlížet reference nebo interagovat s externími nástroji
  bez opuštění formuláře.
icon: manage_search
title: Webbox
---
