---
description: Zjistěte, jak připojit mobilní aplikaci rtSurvey k serveru projektu,
  přistupovat k funkcím specifickým pro role a začít spolupracovat na průzkumech přes
  více projektů.
icon: cloud_sync
