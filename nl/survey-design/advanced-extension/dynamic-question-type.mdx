---
description: Het dynamische vraagtype stelt de widget en het vraagtype van een veld
  in staat om bij uitvoering te worden bepaald op basis van een API-respons of berekende
  waarde.
icon: manage_search
