---
description: Webbox sluit een externe webpagina in de enquête in als een modaal iframe,
  waardoor enumeratoren referenties kunnen bekijken of interacties kunnen uitvoeren
  met externe tools zonder het formulier te verlaten.
icon: manage_search
title: Webbox
---
