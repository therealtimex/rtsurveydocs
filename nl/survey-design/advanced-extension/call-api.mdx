---
description: Met API aanroepen kan uw enquête gegevens ophalen uit een externe webservice
  en de respons gebruiken om velden te vullen of antwoorden te valideren.
icon: manage_search
title: API aanroepen
---
