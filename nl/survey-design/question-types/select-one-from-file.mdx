---
description: select_one_from_file en select_multiple_from_file laden keuzes dynamisch
  vanuit een extern CSV- of XML-bestand dat bij het formulier is bijgevoegd.
