---
description: I tipi di domanda meta acquisiscono automaticamente informazioni sul
  dispositivo, sull'enumeratore e sui tempi senza alcun input dal rispondente.
icon: info
title: Meta
---
