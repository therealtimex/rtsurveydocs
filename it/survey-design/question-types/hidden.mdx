---
description: I campi hidden memorizzano valori che non vengono mai mostrati al rispondente
  — usati per passare contesto, pre-compilare dati o memorizzare risultati intermedi.
icon: eye-slash
title: Hidden
---
