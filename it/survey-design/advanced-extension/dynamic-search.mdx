---
description: La ricerca dinamica carica le scelte da un'API remota in tempo reale
  mentre l'intervistatore digita, consentendo dataset di grandi dimensioni o frequentemente
  aggiornati.
icon: manage_search
