---
description: 'Pattern avanzati per i gruppi di ripetizione: conteggi dinamici, ripetizioni
  annidate, riepilogo dei dati di ripetizione e riferimento ai valori tra le ripetizioni.'
icon: manage_search
