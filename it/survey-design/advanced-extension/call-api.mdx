---
description: Call API consente al tuo sondaggio di recuperare dati da un servizio
  web esterno e usare la risposta per popolare campi o validare risposte.
icon: manage_search
title: Call API
---
