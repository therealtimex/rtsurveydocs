---
description: Il tipo di domanda dinamico consente di determinare il tipo di domanda
  e il widget di un campo in fase di esecuzione in base a una risposta API o a un
  valore calcolato.
icon: manage_search
