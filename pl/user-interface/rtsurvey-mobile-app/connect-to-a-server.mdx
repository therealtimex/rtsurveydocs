---
description: Dowiedz się, jak połączyć aplikację mobilną rtSurvey z serwerem projektu,
  uzyskiwać dostęp do funkcji specyficznych dla ról i zacząć współpracować przy ankietach
  w wielu projektach.
icon: cloud_sync
