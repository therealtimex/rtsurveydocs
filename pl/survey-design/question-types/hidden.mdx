---
description: Ukryte pola przechowują wartości, które nigdy nie są pokazywane respondentowi
  — używane do przekazywania kontekstu, wstępnego wypełniania danych lub przechowywania
  wyników pośrednich.
icon: eye-slash
title: Hidden
---
