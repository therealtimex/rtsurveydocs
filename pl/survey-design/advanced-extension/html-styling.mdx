---
description: rtSurvey obsługuje tagi HTML w etykietach i podpowiedziach, umożliwiając
  formatowanie tekstu sformatowanego, linki i dynamiczne motywy kolorystyczne.
icon: manage_search
title: HTML Styling
---
