---
description: Webbox osadza zewnętrzną stronę internetową wewnątrz ankiety jako modalny
  iframe, umożliwiając ankieterom przeglądanie materiałów referencyjnych lub interakcję
  z zewnętrznymi narzędziami bez opuszczania formularza.
icon: manage_search
title: Webbox
---
