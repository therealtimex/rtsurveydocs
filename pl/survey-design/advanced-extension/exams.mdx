---
description: Funkcja egzaminów dodaje tryb quizu z licznikiem czasu do ankiety, z
  opcjonalną informacją dźwiękową dla poprawnych i niepoprawnych odpowiedzi.
icon: manage_search
title: Exams
---
