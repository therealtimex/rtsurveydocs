...
description: "Dynamisk søgning indlæser valgmuligheder fra et eksternt API i realtid, mens intervieweren skriver, hvilket muliggør store eller hyppigt opdaterede datasæt."
icon: "manage_search"
