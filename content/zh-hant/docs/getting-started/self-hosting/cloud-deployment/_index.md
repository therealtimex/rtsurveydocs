...
icon: "cloud_upload"
toc: true
description: "使用自動化腳本將 rtCloud 部署到 DigitalOcean、AWS EC2、Google Cloud 和 Linode 等主要雲服務商。"
---

部署存儲庫包含針對主要雲服務商的自動化配置腳本。每個腳本在新的 Ubuntu 22.04 LTS 伺服器首次啟動時運行，並執行完全無人值守的設定：
