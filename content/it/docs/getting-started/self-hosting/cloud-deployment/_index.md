...
icon: "cloud_upload"
toc: true
description: "Distribuire rtCloud sui principali provider cloud con script automatizzati per DigitalOcean, AWS EC2, Google Cloud e Linode."
---

Il repository di distribuzione include script di provisioning automatizzati per i principali provider cloud. Ogni script viene eseguito al primo avvio di un nuovo server Ubuntu 22.04 LTS ed esegue una configurazione completamente automatica:
