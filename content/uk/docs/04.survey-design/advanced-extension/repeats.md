...
description: "Розширені шаблони для груп повторів: динамічні лічильники, вкладені повтори, підсумовування даних повторів та посилання на значення між повторами."
icon: "manage_search"
