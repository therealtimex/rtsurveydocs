...
icon: "lock"
toc: true
description: "Налаштуйте єдиний вхід для самостійно розміщеного rtCloud за допомогою вбудованого Keycloak, зовнішнього постачальника OIDC або Azure Active Directory."
---
