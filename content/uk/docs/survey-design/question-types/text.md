...
| `richtext` | Редактор форматованого тексту — панель інструментів з жирним, курсивом, списками та посиланнями |
| `typingtest` | Інтерфейс тесту друку — відображає уривок і вимірює швидкість та точність друку |
