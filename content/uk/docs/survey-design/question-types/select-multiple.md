...
| `tagging` | Варіанти відображаються як чіпи тегів у формі пілюлі |
| `boxtag` | Варіанти відображаються як прямокутні стилізовані блоки |
| `boxtag -search` | Макет boxtag з полем пошуку/фільтрації над блоками |
| `duolingo-style1` | Макет великих карток — найкраще для коротких списків варіантів |
| `rating_box` | Блоки оцінювання у вигляді сітки |
| `choices-noshow` | Спочатку показує перші 10 варіантів; відкриває решту на вимогу |
| `checkall` | Додає опцію "Вибрати всі" у верхній частині списку |
| `max-items(N)` | Обмежує кількість видимих варіантів до N |
{{< /table >}}
