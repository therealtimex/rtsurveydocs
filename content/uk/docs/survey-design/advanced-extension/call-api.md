---
title: "Call API"
description: "Call API дозволяє вашому опитуванню отримувати дані від зовнішнього веб-сервісу та використовувати відповідь для заповнення полів або перевірки відповідей."
icon: "manage_search"
