---
title: "Іспити"
description: "Функція іспиту додає режим тестування з таймером до опитування, з необов'язковою аудіозворотним зв'язком для правильних та неправильних відповідей."
icon: "manage_search"
