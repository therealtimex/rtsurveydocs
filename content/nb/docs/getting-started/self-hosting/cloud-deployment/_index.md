...
icon: "cloud_upload"
toc: true
description: "Distribuer rtCloud hos store skyleverandører med automatiserte skript for DigitalOcean, AWS EC2, Google Cloud og Linode."
---

Distribusjonslageret inkluderer automatiserte provisioneringsscripts for store skyleverandører. Hvert script kjører ved første oppstart av en ny Ubuntu 22.04 LTS-server og utfører en fullstendig automatisert oppsett:
