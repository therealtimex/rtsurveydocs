...
icon: "lock"
toc: true
description: "Single Sign-On konfigurálása önállóan üzemeltetett rtCloud számára beágyazott Keycloak, külső OIDC-szolgáltató vagy Azure Active Directory segítségével."
---
