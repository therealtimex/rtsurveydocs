...
icon: "settings"
toc: true
description: "مرجع كامل لجميع متغيرات البيئة المستخدمة لتكوين نشر rtCloud المستضاف ذاتياً."
---

يتم كل التكوين من خلال متغيرات البيئة في ملف `.env` في جذر دليل النشر. يقرأ Docker Compose هذا الملف تلقائياً — لا حاجة لعلامة `--env-file`.
