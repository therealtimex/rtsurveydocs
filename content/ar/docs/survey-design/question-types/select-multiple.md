...
| `tagging` | تعرض الخيارات كشرائح علامات على شكل حبوب |
| `boxtag` | تعرض الخيارات كمربعات مستطيلة ذات تنسيق خاص |
| `boxtag -search` | تخطيط Boxtag مع حقل بحث/تصفية فوق المربعات |
| `duolingo-style1` | تخطيط بطاقات كبيرة — الأفضل لقوائم الخيارات القصيرة |
| `rating_box` | مربعات تقييم على شكل شبكة |
| `choices-noshow` | يعرض أول 10 خيارات في البداية؛ يكشف عن البقية عند الطلب |
| `checkall` | يضيف خيار "تحديد الكل" في أعلى القائمة |
| `max-items(N)` | يحدد عدد الخيارات المرئية بـ N |
{{< /table >}}
