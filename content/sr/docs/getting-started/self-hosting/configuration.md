...
icon: "settings"
toc: true
description: "Потпуна референца за све променљиве окружења које се користе за конфигурисање самостално хостованог rtCloud."
---

Сва конфигурација се врши кроз променљиве окружења у `.env` датотеци у корену директоријума за примену. Docker Compose чита ову датотеку аутоматски — није потребна заставица `--env-file`.
