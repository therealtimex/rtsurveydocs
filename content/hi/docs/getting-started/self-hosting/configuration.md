...
icon: "settings"
toc: true
description: "सेल्फ-होस्टेड rtCloud डिप्लॉयमेंट को कॉन्फ़िगर करने के लिए उपयोग किए जाने वाले सभी पर्यावरण चर का पूरा संदर्भ।"
---

सभी कॉन्फ़िगरेशन आपके डिप्लॉयमेंट डायरेक्टरी की जड़ में `.env` फ़ाइल में पर्यावरण चर के माध्यम से की जाती है। Docker Compose इस फ़ाइल को स्वचालित रूप से पढ़ता है — `--env-file` फ्लैग की आवश्यकता नहीं।
