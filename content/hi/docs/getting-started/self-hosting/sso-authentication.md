...
icon: "lock"
toc: true
description: "एम्बेडेड Keycloak, बाहरी OIDC प्रदाता, या Azure Active Directory का उपयोग करके सेल्फ-होस्टेड rtCloud के लिए Single Sign-On कॉन्फ़िगर करें।"
---

rtCloud सिंगल साइन-ऑन (SSO) के लिए तीन दृष्टिकोणों का समर्थन करता है:
