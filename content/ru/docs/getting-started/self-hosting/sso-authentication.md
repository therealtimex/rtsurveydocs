...
icon: "lock"
toc: true
description: "Настройте единый вход для самостоятельно размещённого rtCloud с помощью встроенного Keycloak, внешнего поставщика OIDC или Azure Active Directory."
---
