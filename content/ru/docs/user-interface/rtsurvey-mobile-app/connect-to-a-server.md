...
description: "Узнайте, как подключить мобильное приложение rtSurvey к серверу проекта, получить доступ к функциям по ролям и начать совместную работу над опросами."
icon: "cloud_sync"
