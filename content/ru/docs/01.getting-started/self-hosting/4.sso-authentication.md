...
icon: "lock"
toc: true
description: "Настройка единого входа (SSO) для самостоятельно размещённого rtCloud с использованием встроенного Keycloak, внешнего провайдера OIDC или Azure Active Directory."
---
