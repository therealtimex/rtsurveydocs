...
| `richtext` | Редактор форматированного текста — панель инструментов с жирным, курсивом, списками и ссылками |
| `typingtest` | Интерфейс теста на печать — предлагает отрывок и измеряет скорость и точность набора |
