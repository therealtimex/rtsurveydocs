...
description: "Расширенные шаблоны для групп повторений: динамическое количество, вложенные повторения, обобщение данных повторений и ссылки на значения между повторениями."
icon: "manage_search"
