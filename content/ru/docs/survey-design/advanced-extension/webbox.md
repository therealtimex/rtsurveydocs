---
title: "Webbox"
description: "Webbox встраивает внешнюю веб-страницу внутри опроса в виде модального iframe, позволяя перечислителям просматривать справочники или взаимодействовать с внешними инструментами без выхода из формы."
icon: "manage_search"
