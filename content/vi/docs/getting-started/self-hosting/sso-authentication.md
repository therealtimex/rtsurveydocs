...
icon: "lock"
toc: true
description: "Cấu hình Single Sign-On cho rtCloud tự lưu trữ bằng Keycloak nhúng, nhà cung cấp OIDC bên ngoài hoặc Azure Active Directory."
---

rtCloud hỗ trợ ba cách tiếp cận cho Single Sign-On (SSO):
