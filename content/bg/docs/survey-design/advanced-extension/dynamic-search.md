...
description: "Динамичното търсене зарежда опции от отдалечен API в реално време, докато анкетьорът пише, позволявайки работа с големи или часто актуализирани набори от данни."
icon: "manage_search"
