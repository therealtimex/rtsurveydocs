...
description: "rtSurvey поддържа HTML тагове в заглавия и подсказки, позволявайки богато форматиране на текст, връзки и динамично задаване на теми с цветове."
icon: "manage_search"
