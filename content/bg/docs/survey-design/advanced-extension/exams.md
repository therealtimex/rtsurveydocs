---
title: "Изпити"
description: "Функцията за изпити добавя режим на тест с отброяване на времето към анкетата, с незадължителна звукова обратна връзка за верни и грешни отговори."
icon: "manage_search"
