---
title: "Мрежово оформление"
description: "Мрежовото оформление ви позволява да позиционирате полета в CSS мрежа в рамките на група, позволявайки многоколонни дизайни на формуляри."
icon: "manage_search"
