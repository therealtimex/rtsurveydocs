---
title: "Диапазон"
description: "Въпросите от тип range позволяват на респондентите да изберат число чрез плъзгане на плъзгач между дефинирана минимална и максимална стойност."
icon: "sliders"
