...
icon: "cloud_upload"
toc: true
description: "Ota rtCloud käyttöön suurimmilla pilvialustoilla automaattisilla skripteillä DigitalOcean, AWS EC2, Google Cloud ja Linode -palveluihin."
---

Käyttöönottohakemisto sisältää automatisoidut provisiointiskriptit pääpilvialustoille. Jokainen skripti suoritetaan uuden Ubuntu 22.04 LTS -palvelimen ensimmäisellä käynnistyksellä ja suorittaa täysin valvomattoman asennuksen:
