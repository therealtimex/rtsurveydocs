...
| `richtext` | Αντικαθιστά το απλό πεδίο κειμένου με επεξεργαστή εμπλουτισμένου κειμένου (έντονο, πλάγιο, λίστες, συνδέσμους). Αποθηκεύει HTML |
| `typingtest` | Widget δοκιμής πληκτρολόγησης — το κείμενο ετικέτας είναι το απόσπασμα· το widget καταγράφει την πληκτρολογημένη απόκριση και χρονομέτρηση |
