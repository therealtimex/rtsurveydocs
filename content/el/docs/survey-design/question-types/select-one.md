...
| `tagging` | Εμφανίζει επιλογές ως κλικαριστά chips ετικετών αντί κουμπιών επιλογής |
| `boxtag` | Εμφανίζει επιλογές ως στυλιζαρισμένα ορθογώνια κουτιά που ο χρήστης πατά για να επιλέξει |
| `boxtag -search` | Διάταξη boxtag με πεδίο αναζήτησης/φίλτρου πάνω από τα κουτιά |
| `duolingo-style1` | Διάταξη καρτών εμπνευσμένη από Duolingo — μεγάλες κάρτες με εικονίδια |
| `rating_box` | Κουτιά αξιολόγησης πλέγματος — κατάλληλα για αριθμητικές ή κλιμακωτές επιλογές |
| `star_rating` | Widget αστερικής αξιολόγησης — οι επιλογές αποδίδονται ως 1–N αστέρια |
| `choices-noshow` | Αρχικά εμφανίζει μόνο τις πρώτες 10 επιλογές· αποκαλύπτει τις υπόλοιπες κατ' απαίτηση |
| `noshow` | Αποκρύπτει εντελώς τη λίστα επιλογών· η τιμή ορίζεται μέσω κώδικα |
| `checkall` | Προσθέτει επιλογή "Επιλογή όλων" στην κορυφή της λίστας |
| `max-items(N)` | Περιορίζει τον αριθμό των ορατών επιλογών σε N |
{{< /table >}}
