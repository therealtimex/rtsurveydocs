---
title: "Στυλ HTML"
description: "Το rtSurvey υποστηρίζει ετικέτες HTML σε ετικέτες και υποδείξεις, επιτρέποντας μορφοποίηση εμπλουτισμένου κειμένου, συνδέσμους και δυναμικό θεματισμό χρωμάτων."
icon: "manage_search"
