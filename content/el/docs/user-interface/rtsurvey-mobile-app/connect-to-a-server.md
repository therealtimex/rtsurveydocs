...
description: "Μάθετε πώς να συνδέσετε την εφαρμογή κινητού rtSurvey στον διακομιστή έργου σας, να αποκτήσετε πρόσβαση σε λειτουργίες ανά ρόλο και να αρχίσετε συνεργασία σε έρευνες σε πολλά έργα."
icon: "cloud_sync"
