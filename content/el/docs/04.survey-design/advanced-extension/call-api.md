---
title: "Call API"
description: "Το Call API επιτρέπει στην έρευνά σας να ανακτά δεδομένα από εξωτερική διαδικτυακή υπηρεσία και να χρησιμοποιεί την απόκριση για συμπλήρωση πεδίων ή επικύρωση απαντήσεων."
icon: "manage_search"
