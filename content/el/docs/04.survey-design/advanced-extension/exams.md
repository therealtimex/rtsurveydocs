---
title: "Εξετάσεις"
description: "Η δυνατότητα εξέτασης προσθέτει λειτουργία κουίζ με χρονόμετρο σε έρευνα, με προαιρετικά ηχητικά σήματα για σωστές και λανθασμένες απαντήσεις."
icon: "manage_search"
