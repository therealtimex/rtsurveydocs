...
icon: "lock"
toc: true
description: "Konfigūruokite Single Sign-On savastiškai patalpintam rtCloud naudojant integruotą Keycloak, išorinį OIDC teikėją arba Azure Active Directory."
---

rtCloud palaiko tris vieningojo prisijungimo (SSO) metodus:
