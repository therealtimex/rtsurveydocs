...
icon: "lock"
toc: true
description: "Konfigurera Single Sign-On för egenhostad rtCloud med inbyggd Keycloak, en extern OIDC-leverantör eller Azure Active Directory."
---

rtCloud stöder tre metoder för Single Sign-On (SSO):
