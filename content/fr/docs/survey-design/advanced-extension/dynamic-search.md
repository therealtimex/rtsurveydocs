...
description: "La recherche dynamique charge les choix depuis une API distante en temps réel au fil de la saisie de l'enquêteur, permettant des jeux de données volumineux ou fréquemment mis à jour."
icon: "manage_search"
