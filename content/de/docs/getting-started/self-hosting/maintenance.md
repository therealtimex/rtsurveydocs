...
icon: "build"
toc: true
description: "Tägliche Wartung einer selbst gehosteten rtCloud-Instanz: Upgrades, Backups, Wiederherstellung und Fehlerbehebung."
---

## Häufige Befehle

Verwenden Sie diese Befehle regelmäßig zur Verwaltung Ihrer rtCloud-Container. Führen Sie sie aus dem Verzeichnis aus, das `docker-compose.production.yml` enthält.
