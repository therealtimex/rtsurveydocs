...
icon: "settings"
toc: true
description: "เอกสารอ้างอิงครบถ้วนสำหรับตัวแปรสภาพแวดล้อมทั้งหมดที่ใช้ในการกำหนดค่าการติดตั้ง rtCloud ที่โฮสต์เอง"
---

การกำหนดค่าทั้งหมดทำผ่านตัวแปรสภาพแวดล้อมในไฟล์ `.env` ที่รูทของไดเรกทอรีการติดตั้ง Docker Compose อ่านไฟล์นี้โดยอัตโนมัติ — ไม่ต้องใช้ flag `--env-file`
