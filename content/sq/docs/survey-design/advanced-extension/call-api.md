---
title: "Call API"
description: "Call API lejon sondazhin tuaj të marrë të dhëna nga shërbim i jashtëm web dhe të përdorë përgjigjen për të plotësuar fushat ose validuar përgjigjet."
icon: "manage_search"
