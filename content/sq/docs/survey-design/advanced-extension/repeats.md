...
description: "Modele të avancuara për grupet e përsëritjes: numërime dinamike, përsëritje të ndërfutura, përmbledhja e të dhënave të përsëritjes dhe referimi i vlerave nëpër përsëritje."
icon: "manage_search"
