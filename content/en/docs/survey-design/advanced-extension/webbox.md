---
title: "Webbox"
description: "Webbox embeds an external web page inside the survey as a modal iframe, allowing enumerators to view references or interact with external tools without leaving the form."
icon: "manage_search"
