...
description: "Dynamic question type allows a field's question type and widget to be determined at runtime based on an API response or calculated value."
icon: "manage_search"
...
## Example: Configurable inspection form
