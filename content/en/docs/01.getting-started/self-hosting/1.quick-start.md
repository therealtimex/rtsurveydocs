...
| Provider | Guide |
|----------|-------|
| Linode (Akamai) | [Deploy on Linode](../3.cloud-deployment/2.linode) — easiest, form-based setup via StackScript |
| DigitalOcean | [Deploy on DigitalOcean](../3.cloud-deployment/1.digitalocean) |
| AWS EC2 | [Deploy on AWS](../3.cloud-deployment/3.aws) |
| Google Cloud | [Deploy on GCP](../3.cloud-deployment/4.gcp) |
