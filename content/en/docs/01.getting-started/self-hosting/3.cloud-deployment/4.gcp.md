...
| `ADMIN_PASSWORD` | No | App admin password. Leave blank to auto-generate. |
| `DOCKER_HUB_PASSWORD` | Yes | Docker Hub password or access token. |
...
When setup completes, the log shows a summary with your app URL, admin credentials, and all generated passwords.
