...
| Script | Description |
|--------|-------------|
| [digitalocean-droplet-keycloak-embed.sh](/scripts/digitalocean-droplet-keycloak-embed.sh) | Embedded Keycloak (Recommended) |
| [digitalocean-droplet.sh](/scripts/digitalocean-droplet.sh) | Full script — Keycloak + External OIDC + HTTP-only |
