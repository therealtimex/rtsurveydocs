...
description: "O tipo de pergunta dinâmico permite que o tipo de widget de um campo seja determinado em tempo de execução com base numa resposta de API ou valor calculado."
icon: "manage_search"
