...
icon: "lock"
toc: true
description: "내장된 Keycloak, 외부 OIDC 공급자 또는 Azure Active Directory를 사용하여 자체 호스팅 rtCloud에 Single Sign-On을 구성합니다."
---

rtCloud은 Single Sign-On(SSO)에 대한 세 가지 접근 방식을 지원합니다:
