---
description: rtSurvey मोबाइल ऐप को अपने प्रोजेक्ट सर्वर से कनेक्ट करना, भूमिका-विशिष्ट
  कार्यात्मकताएं एक्सेस करना और कई परियोजनाओं में सर्वेक्षणों पर सहयोग शुरू करना सीखें।
icon: cloud_sync
