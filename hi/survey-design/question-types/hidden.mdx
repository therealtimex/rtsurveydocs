---
description: Hidden fields ऐसे values store करते हैं जो कभी उत्तरदाता को नहीं दिखाए
  जाते — context pass करने, data prefill करने, या intermediate results store करने
