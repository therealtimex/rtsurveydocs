---
description: Geotrace questions उत्तरदाताओं को map पर connected points की series capture
  करने देते हैं, survey के हिस्से के रूप में lines या paths बनाते हैं।
icon: timeline
title: Geotrace
---
