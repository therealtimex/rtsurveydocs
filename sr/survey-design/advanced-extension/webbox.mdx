---
description: Webbox ugrađuje spoljnu veb stranicu unutar ankete kao modalni iframe,
  dozvoljavajući anketarima da pregledaju reference ili interaguju sa spoljnim alatima
  bez napuštanja formulara.
icon: manage_search
title: Webbox
---
