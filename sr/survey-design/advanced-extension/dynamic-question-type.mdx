---
description: Dinamički tip pitanja omogućava da tip pitanja i widget polja budu određeni
  u vreme izvođenja na osnovu API odgovora ili izračunate vrednosti.
icon: manage_search
