---
description: 'Napredni obrasci za grupe ponavljanja: dinamički broj, ugnežđena ponavljanja,
  sumiranje podataka ponavljanja i referenciranje vrednosti kroz ponavljanja.'
icon: manage_search
