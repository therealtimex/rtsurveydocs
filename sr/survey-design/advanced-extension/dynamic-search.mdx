---
description: Dinamička pretraga učitava opcije iz udaljenog API-ja u realnom vremenu
  dok anketar kuca, omogućavajući velike ili često ažurirane skupove podataka.
icon: manage_search
