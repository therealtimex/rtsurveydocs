---
description: Naučite kako da povežete rtSurvey mobilnu aplikaciju sa serverom projekta,
  pristupite funkcionalnostima specifičnim za uloge i počnete saradnju na anketama
  u više projekata.
icon: cloud_sync
