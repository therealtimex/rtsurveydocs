---
description: O recurso de exame adiciona um modo de questionário cronometrado a uma
  pesquisa, com feedback de áudio opcional para respostas corretas e incorretas.
icon: manage_search
title: Exames
---
