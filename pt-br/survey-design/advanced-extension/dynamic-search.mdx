---
description: A Busca dinâmica carrega opções de uma API remota em tempo real conforme
  o entrevistador digita, habilitando conjuntos de dados grandes ou frequentemente
  atualizados.
icon: manage_search
