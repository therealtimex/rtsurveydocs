---
description: O Webbox incorpora uma página web externa dentro da pesquisa como um
  iframe modal, permitindo que os entrevistadores visualizem referências ou interajam
  com ferramentas externas sem sair do formulário.
icon: manage_search
title: Webbox
---
