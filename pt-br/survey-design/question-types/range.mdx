---
description: As perguntas de intervalo permitem que os respondentes selecionem um
  número arrastando um controle deslizante entre um valor mínimo e máximo definido.
icon: sliders
title: Intervalo
---
