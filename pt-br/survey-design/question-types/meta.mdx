---
description: Os tipos de perguntas meta capturam automaticamente informações do dispositivo,
  do entrevistador e de tempo sem qualquer entrada do respondente.
icon: info
title: Meta
---
