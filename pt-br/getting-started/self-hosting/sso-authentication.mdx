---
description: Configure o Single Sign-On para o rtCloud com hospedagem própria usando
  o Keycloak integrado, um provedor OIDC externo ou o Azure Active Directory.
icon: lock
