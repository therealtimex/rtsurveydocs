---
title: "Поддержка"
description: "Получите помощь по rtSurvey — документация, GitHub Issues и ресурсы сообщества."
---
...
rtSurvey — это платформа с открытым исходным кодом и самостоятельным размещением. Поддержка осуществляется через GitHub и каналы сообщества.
...
>
  Сообщайте об ошибках, запрашивайте функции или просматривайте известные проблемы.
</FeatureCard>
...
>
  Задавайте вопросы и получайте помощь от сообщества.
</FeatureCard>
...
>
  Просматривайте полную документацию rtSurvey.
</FeatureCard>
...
>
  Свяжитесь с нами напрямую по адресу support+info@rta.vn.
</FeatureCard>
...
>
  Информация о продукте, демонстрации и корпоративные запросы.
</FeatureCard>
...
>
  Подписывайтесь на @RtSurvey для получения обновлений и анонсов.
</FeatureCard>
...
Пожалуйста, просмотрите [существующие задачи](https://github.com/therealtimex/rtsurvey/issues) перед созданием новой. Укажите:

- Версию rtSurvey
- Метод развёртывания (Linode StackScript, DigitalOcean, ручной Docker)
- Шаги для воспроизведения
- Соответствующие журналы (`docker compose logs`)
