---
title: "Документация rtSurvey"
description: "Официальная документация rtSurvey — самостоятельно размещаемая платформа для мобильного сбора данных и опросов."
---

import FeatureCard from '../components/FeatureCard';

# Документация rtSurvey

Добро пожаловать в официальную документацию **rtSurvey** — самостоятельно размещаемой платформы для разработки форм, сбора данных в полевых условиях и анализа результатов в режиме реального времени.
...
>
  Впервые используете rtSurvey? Начните здесь для обзора платформы.
</FeatureCard>
...
>
  Разверните на Linode, DigitalOcean или любом сервере Linux.
</FeatureCard>

<FeatureCard
  title="Разработка опросов"
...
>
  Создавайте формы с вопросами, логикой, медиа и повторениями.
</FeatureCard>

<FeatureCard
  title="Интерфейсы платформы"
...
>
  Изучите веб-приложение, мобильное приложение и веб-форму.
</FeatureCard>
...
>
  GitHub Issues, обсуждения сообщества и поддержка по электронной почте.
</FeatureCard>
...
>
  Просматривайте исходный код, открывайте задачи и вносите вклад.
</FeatureCard>
