---
title: "Support"
description: "Holen Sie sich Hilfe zu rtSurvey — Dokumentation, GitHub Issues und Community-Ressourcen."
---
...
rtSurvey ist eine Open-Source-Plattform mit Selbst-Hosting. Support wird über GitHub und Community-Kanäle bereitgestellt.
...
>
  Fehler melden, Features anfordern oder bekannte Probleme durchsuchen.
</FeatureCard>
...
>
  Die vollständige rtSurvey-Dokumentation durchsuchen.
</FeatureCard>
...
>
  Kontaktieren Sie uns direkt unter support+info@rta.vn.
</FeatureCard>

<FeatureCard
  title="rtSurvey Webseite"
...
>
  Produktinformationen, Demos und Unternehmensanfragen.
</FeatureCard>
...
>
  Folgen Sie @RtSurvey für Updates und Ankündigungen.
</FeatureCard>

</div>

## Vor dem Öffnen eines Issues

Bitte durchsuchen Sie [vorhandene Issues](https://github.com/therealtimex/rtsurvey/issues), bevor Sie ein neues erstellen. Fügen Sie hinzu:

- rtSurvey-Version
- Bereitstellungsmethode (Linode StackScript, DigitalOcean, manuelles Docker)
- Schritte zur Reproduktion
- Relevante Logs (`docker compose logs`)
