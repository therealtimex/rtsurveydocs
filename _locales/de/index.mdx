---
title: "rtSurvey Dokumentation"
description: "Offizielle Dokumentation für rtSurvey — eine selbst gehostete Plattform für mobile Datenerhebung und Umfragen."
---

import FeatureCard from '../components/FeatureCard';

# rtSurvey Dokumentation

Willkommen in der offiziellen Dokumentation für **rtSurvey** — eine selbst gehostete Plattform zum Entwerfen von Formularen, Erfassen von Daten im Feld und Analysieren von Ergebnissen in Echtzeit.
...
>
  Neu bei rtSurvey? Beginnen Sie hier mit einem Überblick über die Plattform.
</FeatureCard>
...
>
  Auf Linode, DigitalOcean oder einem beliebigen Linux-Server bereitstellen.
</FeatureCard>

<FeatureCard
  title="Umfragegestaltung"
...
>
  Formulare mit Fragen, Logik, Medien und Wiederholungen erstellen.
</FeatureCard>

<FeatureCard
  title="Plattform-Oberflächen"
...
>
  Web-App, mobile App und Webformulare erkunden.
</FeatureCard>
...
>
  GitHub Issues, Community-Diskussionen und E-Mail-Support.
</FeatureCard>
...
>
  Quellcode ansehen, Issues öffnen und beitragen.
</FeatureCard>
