---
title: "rtSurvey दस्तावेज़ीकरण"
description: "rtSurvey के लिए आधिकारिक दस्तावेज़ीकरण — एक स्व-होस्टेड मोबाइल डेटा संग्रह और सर्वेक्षण प्लेटफ़ॉर्म।"
---

import FeatureCard from '../components/FeatureCard';

# rtSurvey दस्तावेज़ीकरण

**rtSurvey** के आधिकारिक दस्तावेज़ीकरण में आपका स्वागत है — फॉर्म डिज़ाइन करने, फ़ील्ड में डेटा एकत्र करने और वास्तविक समय में परिणामों का विश्लेषण करने के लिए एक स्व-होस्टेड प्लेटफ़ॉर्म।
...
>
  rtSurvey में नए हैं? प्लेटफ़ॉर्म का अवलोकन पाने के लिए यहाँ से शुरू करें।
</FeatureCard>
...
>
  Linode, DigitalOcean या किसी भी Linux सर्वर पर तैनात करें।
</FeatureCard>
...
>
  प्रश्नों, तर्क, मीडिया और दोहराव के साथ फॉर्म बनाएं।
</FeatureCard>

<FeatureCard
  title="प्लेटफ़ॉर्म इंटरफ़ेस"
...
>
  वेब ऐप, मोबाइल ऐप और वेब फॉर्म का अन्वेषण करें।
</FeatureCard>
...
>
  GitHub Issues, समुदाय चर्चाएं और ईमेल सहायता।
</FeatureCard>
...
>
  स्रोत देखें, issues खोलें और योगदान करें।
</FeatureCard>
