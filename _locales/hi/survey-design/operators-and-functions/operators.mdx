...
उदाहरण 1:
<Callout type="info">`${age} = 3 or ${age} = 4` `true` return करेगी यदि age 3 या 4 है।</Callout>

उदाहरण 2:
<Callout type="info">`${age} > 3 and ${age} < 5` `true` return करेगी यदि age 3 और 5 के बीच है।</Callout>

उदाहरण 3:
<Callout type="info">`not(${age} > 3 and ${age} < 5)` `true` return करेगी यदि age 3 और 5 के बीच नहीं है।</Callout>
