---
title: "Suporte"
description: "Obtenha ajuda com o rtSurvey — documentação, GitHub Issues e recursos da comunidade."
---
...
O rtSurvey é uma plataforma open-source e auto-hospedada. O suporte é fornecido através do GitHub e de canais comunitários.
...
>
  Reporte bugs, solicite funcionalidades ou veja problemas conhecidos.
</FeatureCard>

<FeatureCard
  title="Discussões no GitHub"
...
>
  Faça perguntas e receba ajuda da comunidade.
</FeatureCard>
...
>
  Navegue pela documentação completa do rtSurvey.
</FeatureCard>
...
>
  Entre em contato diretamente em support+info@rta.vn.
</FeatureCard>

<FeatureCard
  title="Site do rtSurvey"
...
>
  Informações do produto, demonstrações e consultas empresariais.
</FeatureCard>
...
>
  Siga @RtSurvey para atualizações e novidades.
</FeatureCard>
...
Por favor, pesquise [issues existentes](https://github.com/therealtimex/rtsurvey/issues) antes de criar uma nova. Inclua:

- Versão do rtSurvey
- Método de implantação (Linode StackScript, DigitalOcean, Docker manual)
