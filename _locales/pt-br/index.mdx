---
title: "Documentação rtSurvey"
description: "Documentação oficial do rtSurvey — uma plataforma auto-hospedada de coleta de dados móveis e pesquisas."
---

import FeatureCard from '../components/FeatureCard';

# Documentação rtSurvey

Bem-vindo à documentação oficial do **rtSurvey** — uma plataforma auto-hospedada para projetar formulários, coletar dados em campo e analisar resultados em tempo real.
...
>
  Novo no rtSurvey? Comece aqui para uma visão geral da plataforma.
</FeatureCard>
...
>
  Implante no Linode, DigitalOcean ou em qualquer servidor Linux.
</FeatureCard>

<FeatureCard
  title="Design de Pesquisas"
...
>
  Crie formulários com perguntas, lógica, mídia e repetições.
</FeatureCard>
...
>
  Explore o aplicativo web, o aplicativo móvel e o formulário web.
</FeatureCard>
...
>
  GitHub Issues, discussões da comunidade e suporte por e-mail.
</FeatureCard>
...
>
  Veja o código-fonte, abra problemas e contribua.
</FeatureCard>
