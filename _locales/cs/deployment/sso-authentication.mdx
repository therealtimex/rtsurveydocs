...
| Option | Best For |
|--------|----------|
| [Embedded Keycloak](#integrovaný-keycloak) | Organizations that want a fully self-contained SSO server bundled with rtCloud |
| [External OIDC Provider](#externí-oidc-poskytovatel) | Organizations already running an identity provider (Auth0, Authentik, Okta, Supabase, etc.) |
...
### Automatické přidělování uživatelů
