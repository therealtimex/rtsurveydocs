---
title: "Dokumentace rtSurvey"
description: "Oficiální dokumentace pro rtSurvey — self-hostovaná platforma pro mobilní sběr dat a průzkumy."
---

import FeatureCard from '../components/FeatureCard';

# Dokumentace rtSurvey

Vítejte v oficiální dokumentaci pro **rtSurvey** — self-hostovanou platformu pro navrhování formulářů, sběr dat v terénu a analýzu výsledků v reálném čase.
...
>
  Jste nováček v rtSurvey? Začněte zde a získejte přehled o platformě.
</FeatureCard>
...
>
  Nasaďte na Linode, DigitalOcean nebo jakýkoli Linux server.
</FeatureCard>
...
>
  Vytvářejte formuláře s otázkami, logikou, médii a opakováními.
</FeatureCard>

<FeatureCard
  title="Rozhraní platformy"
...
>
  Prozkoumejte webovou aplikaci, mobilní aplikaci a webové formuláře.
</FeatureCard>
...
>
  GitHub Issues, komunitní diskuse a e-mailová podpora.
</FeatureCard>
...
>
  Prohlédněte zdrojový kód, otevřete issues a přispívejte.
</FeatureCard>
