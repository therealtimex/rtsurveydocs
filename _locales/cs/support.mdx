---
title: "Podpora"
description: "Získejte pomoc s rtSurvey — dokumentace, GitHub Issues a komunitní zdroje."
---
...
rtSurvey je open-source, self-hostovaná platforma. Podpora je poskytována prostřednictvím GitHub a komunitních kanálů.
...
>
  Hlaste chyby, požadujte funkce nebo procházejte známé problémy.
</FeatureCard>
...
>
  Ptejte se a získejte pomoc od komunity.
</FeatureCard>
...
>
  Procházejte úplnou dokumentaci rtSurvey.
</FeatureCard>
...
>
  Kontaktujte nás přímo na support+info@rta.vn.
</FeatureCard>

<FeatureCard
  title="Webové stránky rtSurvey"
...
>
  Informace o produktu, ukázky a firemní dotazy.
</FeatureCard>
...
>
  Sledujte @RtSurvey pro aktualizace a oznámení.
</FeatureCard>

</div>

## Před otevřením issue

Prosím prohledejte [existující issues](https://github.com/therealtimex/rtsurvey/issues) před vytvořením nového. Uveďte:

- Verzi rtSurvey
- Způsob nasazení (Linode StackScript, DigitalOcean, ruční Docker)
- Kroky k reprodukci
- Příslušné logy (`docker compose logs`)
