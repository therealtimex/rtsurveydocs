---
title: "Podpora"
description: "Získajte pomoc s rtSurvey — dokumentácia, GitHub Issues a komunitné zdroje."
---
...
rtSurvey je open-source platforma so samostatným hostingom. Podpora je poskytovaná prostredníctvom GitHubu a komunitných kanálov.
...
>
  Nahláste chyby, požiadajte o funkcie alebo si prezrite známe problémy.
</FeatureCard>

<FeatureCard
  title="Diskusie na GitHub"
...
>
  Pýtajte sa a získajte pomoc od komunity.
</FeatureCard>
...
>
  Prezrite si kompletnú dokumentáciu rtSurvey.
</FeatureCard>

<FeatureCard
  title="Podpora e-mailom"
...
>
  Kontaktujte nás priamo na support+info@rta.vn.
</FeatureCard>

<FeatureCard
  title="Webová stránka rtSurvey"
...
>
  Informácie o produkte, ukážky a podnikové otázky.
</FeatureCard>
...
>
  Sledujte @RtSurvey pre aktualizácie a oznámenia.
</FeatureCard>

</div>

## Pred otvorením problému

Prosím, prehľadajte [existujúce problémy](https://github.com/therealtimex/rtsurvey/issues) pred vytvorením nového. Uveďte:

- Verziu rtSurvey
- Metódu nasadenia (Linode StackScript, DigitalOcean, manuálny Docker)
- Kroky na reprodukciu
- Relevantné záznamy (`docker compose logs`)
