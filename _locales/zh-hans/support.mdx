---
title: "支持"
description: "获取 rtSurvey 帮助 — 文档、GitHub Issues 和社区资源。"
---
...
rtSurvey 是一个开源自托管平台。支持通过 GitHub 和社区渠道提供。
...
请在创建新 Issue 前搜索[现有 Issues](https://github.com/therealtimex/rtsurvey/issues)。包含以下信息：

- rtSurvey 版本
- 部署方式（Linode StackScript、DigitalOcean、手动 Docker）
- 重现步骤
