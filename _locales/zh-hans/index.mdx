---
title: "rtSurvey 文档"
description: "rtSurvey 官方文档 — 自托管移动数据采集与调查平台。"
---
...
欢迎阅读 **rtSurvey** 官方文档 — 一个用于设计表单、现场数据采集和实时分析结果的自托管平台。
...
>
  在 Linode、DigitalOcean 或任何 Linux 服务器上部署。
</FeatureCard>
