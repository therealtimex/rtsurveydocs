...
| Option | Best For |
|--------|----------|
| [Embedded Keycloak](#keycloak-i-integruar) | Organizations that want a fully self-contained SSO server bundled with rtCloud |
| [External OIDC Provider](#ofruesi-i-jashtëm-oidc) | Organizations already running an identity provider (Auth0, Authentik, Okta, Supabase, etc.) |
