---
title: "Mbështetja"
description: "Merrni ndihmë me rtSurvey — dokumentimi, GitHub Issues dhe burimet e komunitetit."
---
...
rtSurvey është një platformë me burim të hapur, e vetë-pritur. Mbështetja ofrohet përmes GitHub dhe kanaleve të komunitetit.
...
>
  Raportoni gabime, kërkoni veçori, ose shfletoni çështjet e njohura.
</FeatureCard>
...
>
  Bëni pyetje dhe merrni ndihmë nga komuniteti.
</FeatureCard>
...
>
  Shfletoni dokumentimin e plotë të rtSurvey.
</FeatureCard>
...
>
  Na kontaktoni direkt në support+info@rta.vn.
</FeatureCard>

<FeatureCard
  title="Faqja e rtSurvey"
...
>
  Informacione mbi produktin, demo dhe pyetje enterprise.
</FeatureCard>
...
>
  Ndiqni @RtSurvey për përditësime dhe njoftime.
</FeatureCard>

</div>

## Para se të Hapni një Çështje

Ju lutemi kërkoni [çështjet ekzistuese](https://github.com/therealtimex/rtsurvey/issues) para se të krijoni një të re. Përfshini:

- Versioni i rtSurvey
- Metoda e vendosjes (Linode StackScript, DigitalOcean, Docker manual)
- Hapat për të riprodhuar
- Regjistrimet përkatëse (`docker compose logs`)
