---
title: "Dukungan"
description: "Dapatkan bantuan dengan rtSurvey — dokumentasi, GitHub Issues, dan sumber daya komunitas."
---
...
rtSurvey adalah platform open-source yang dihosting sendiri. Dukungan diberikan melalui GitHub dan saluran komunitas.
...
>
  Laporkan bug, minta fitur, atau telusuri masalah yang diketahui.
</FeatureCard>
...
>
  Ajukan pertanyaan dan dapatkan bantuan dari komunitas.
</FeatureCard>
...
>
  Telusuri dokumentasi rtSurvey lengkap.
</FeatureCard>
...
>
  Hubungi kami langsung di support+info@rta.vn.
</FeatureCard>

<FeatureCard
  title="Website rtSurvey"
...
>
  Informasi produk, demo, dan pertanyaan enterprise.
</FeatureCard>
...
>
  Ikuti @RtSurvey untuk pembaruan dan pengumuman.
</FeatureCard>
...
Harap cari [isu yang sudah ada](https://github.com/therealtimex/rtsurvey/issues) sebelum membuat yang baru. Sertakan:

- Versi rtSurvey
- Metode deployment (Linode StackScript, DigitalOcean, Docker manual)
- Langkah-langkah untuk mereproduksi
- Log yang relevan (`docker compose logs`)
