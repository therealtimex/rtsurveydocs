---
title: "Dokumentasi rtSurvey"
description: "Dokumentasi resmi untuk rtSurvey — platform pengumpulan data mobile dan survei yang dihosting sendiri."
---

import FeatureCard from '../components/FeatureCard';

# Dokumentasi rtSurvey

Selamat datang di dokumentasi resmi **rtSurvey** — platform yang dihosting sendiri untuk merancang formulir, mengumpulkan data di lapangan, dan menganalisis hasil secara real time.
...
>
  Baru menggunakan rtSurvey? Mulai di sini untuk gambaran umum platform.
</FeatureCard>
...
>
  Deploy di Linode, DigitalOcean, atau server Linux mana pun.
</FeatureCard>
...
>
  Buat formulir dengan pertanyaan, logika, media, dan pengulangan.
</FeatureCard>
...
>
  Jelajahi aplikasi web, aplikasi mobile, dan formulir web.
</FeatureCard>
...
>
  GitHub Issues, diskusi komunitas, dan dukungan email.
</FeatureCard>
...
>
  Lihat sumber, buka isu, dan berkontribusi.
</FeatureCard>
