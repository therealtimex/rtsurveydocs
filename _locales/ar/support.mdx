---
title: "الدعم"
description: "احصل على مساعدة بشأن rtSurvey — التوثيق ومشكلات GitHub وموارد المجتمع."
---
...
rtSurvey منصة مفتوحة المصدر ومستضافة ذاتياً. يتم تقديم الدعم عبر GitHub وقنوات المجتمع.
...
>
  الإبلاغ عن الأخطاء وطلب الميزات أو تصفح المشكلات المعروفة.
</FeatureCard>
...
>
  اطرح أسئلتك واحصل على مساعدة من المجتمع.
</FeatureCard>
...
>
  تواصل معنا مباشرة على support+info@rta.vn.
</FeatureCard>
...
>
  معلومات المنتج والعروض التوضيحية والاستفسارات المؤسسية.
</FeatureCard>
...
>
  تابع @RtSurvey للتحديثات والإعلانات.
</FeatureCard>
...
يرجى البحث في [المشكلات الموجودة](https://github.com/therealtimex/rtsurvey/issues) قبل إنشاء مشكلة جديدة. تضمين:

- إصدار rtSurvey
- طريقة النشر (Linode StackScript، DigitalOcean، Docker يدوي)
- خطوات إعادة الإنتاج
- السجلات ذات الصلة (`docker compose logs`)
