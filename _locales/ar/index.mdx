---
title: "توثيق rtSurvey"
description: "التوثيق الرسمي لـ rtSurvey — منصة تجميع البيانات الميدانية والاستبيانات المستضافة ذاتياً."
---
...
مرحباً بك في التوثيق الرسمي لـ **rtSurvey** — منصة مستضافة ذاتياً لتصميم النماذج وجمع البيانات الميدانية وتحليل النتائج في الوقت الفعلي.
...
>
  جديد على rtSurvey؟ ابدأ هنا للحصول على نظرة عامة على المنصة.
</FeatureCard>
...
>
  انشر على Linode أو DigitalOcean أو أي خادم Linux.
</FeatureCard>

<FeatureCard
  title="تصميم الاستبيان"
...
>
  بناء النماذج بالأسئلة والمنطق والوسائط والتكرار.
</FeatureCard>
...
>
  استكشف تطبيق الويب والتطبيق المحمول ونماذج الويب.
</FeatureCard>
...
>
  مشكلات GitHub ومناقشات المجتمع ودعم البريد الإلكتروني.
</FeatureCard>
...
>
  عرض الكود المصدري وفتح المشكلات والمساهمة.
</FeatureCard>
