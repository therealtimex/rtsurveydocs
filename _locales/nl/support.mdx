---
title: "Ondersteuning"
description: "Krijg hulp met rtSurvey — documentatie, GitHub Issues en gemeenschapsbronnen."
---
...
rtSurvey is een open-source, zelfgehost platform. Ondersteuning wordt geboden via GitHub en gemeenschapskanalen.
...
>
  Meld bugs, vraag functies aan of blader door bekende problemen.
</FeatureCard>
...
>
  Stel vragen en krijg hulp van de gemeenschap.
</FeatureCard>
...
>
  Blader door de volledige rtSurvey-documentatie.
</FeatureCard>
...
>
  Neem direct contact met ons op via support+info@rta.vn.
</FeatureCard>
...
>
  Productinformatie, demo's en zakelijke vragen.
</FeatureCard>
...
>
  Volg @RtSurvey voor updates en aankondigingen.
</FeatureCard>

</div>

## Voordat u een issue opent

Zoek in [bestaande issues](https://github.com/therealtimex/rtsurvey/issues) voordat u een nieuw issue aanmaakt. Voeg het volgende toe:

- rtSurvey-versie
- Implementatiemethode (Linode StackScript, DigitalOcean, handmatige Docker)
