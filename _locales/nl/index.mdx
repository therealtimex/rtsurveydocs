---
title: "rtSurvey documentatie"
description: "Officiële documentatie voor rtSurvey — een zelfgehost mobiel dataverzameling- en enquêteplatform."
---

import FeatureCard from '../components/FeatureCard';

# rtSurvey documentatie

Welkom bij de officiële documentatie voor **rtSurvey** — een zelfgehost platform voor het ontwerpen van formulieren, gegevensverzameling in het veld en realtime analyse van resultaten.
...
>
  Nieuw bij rtSurvey? Begin hier voor een platformoverzicht.
</FeatureCard>
...
>
  Implementeer op Linode, DigitalOcean of een Linux-server naar keuze.
</FeatureCard>
...
>
  Bouw formulieren met vragen, logica, media en herhalingen.
</FeatureCard>

<FeatureCard
  title="Platforminterfaces"
...
>
  Verken de webapplicatie, mobiele app en webformulier.
</FeatureCard>
...
>
  GitHub Issues, gemeenschapsdiscussies en e-mailondersteuning.
</FeatureCard>
...
>
  Bekijk broncode, open issues en draag bij.
</FeatureCard>
