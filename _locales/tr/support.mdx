---
title: "Destek"
description: "rtSurvey ile ilgili yardım alın — belgeler, GitHub Issues ve topluluk kaynakları."
---
...
rtSurvey, açık kaynaklı, kendi kendine barındırılan bir platformdur. Destek GitHub ve topluluk kanalları aracılığıyla sağlanmaktadır.
...
>
  Hata bildirin, özellik isteyin veya bilinen sorunlara göz atın.
</FeatureCard>

<FeatureCard
  title="GitHub Tartışmaları"
...
>
  Soru sorun ve topluluktan yardım alın.
</FeatureCard>
...
>
  rtSurvey belgelerinin tamamına göz atın.
</FeatureCard>
...
>
  support+info@rta.vn adresinden doğrudan bize ulaşın.
</FeatureCard>

<FeatureCard
  title="rtSurvey Web Sitesi"
...
>
  Ürün bilgileri, demolar ve kurumsal sorular.
</FeatureCard>
...
>
  Güncellemeler ve duyurular için @RtSurvey'i takip edin.
</FeatureCard>
...
Yeni bir sorun oluşturmadan önce lütfen [mevcut sorunları](https://github.com/therealtimex/rtsurvey/issues) arayın. Şunları ekleyin:

- rtSurvey sürümü
- Dağıtım yöntemi (Linode StackScript, DigitalOcean, manuel Docker)
- Yeniden üretme adımları
- İlgili günlükler (`docker compose logs`)
