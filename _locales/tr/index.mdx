---
title: "rtSurvey Belgeleri"
description: "rtSurvey için resmi belgeler — kendi kendine barındırılan mobil veri toplama ve anket platformu."
---
...
**rtSurvey** için resmi belgelere hoş geldiniz — form tasarlamak, sahada veri toplamak ve sonuçları gerçek zamanlı analiz etmek için kendi kendine barındırılan bir platform.
...
>
  rtSurvey'e yeni misiniz? Platform genel bakışı için buradan başlayın.
</FeatureCard>
...
>
  Linode, DigitalOcean veya herhangi bir Linux sunucusuna dağıtın.
</FeatureCard>
...
>
  Sorular, mantık, medya ve tekrarlarla formlar oluşturun.
</FeatureCard>

<FeatureCard
  title="Platform Arayüzleri"
...
>
  Web uygulamasını, mobil uygulamayı ve web formunu keşfedin.
</FeatureCard>
...
>
  GitHub Issues, topluluk tartışmaları ve e-posta desteği.
</FeatureCard>
...
>
  Kaynak kodunu görüntüleyin, sorun açın ve katkıda bulunun.
</FeatureCard>
