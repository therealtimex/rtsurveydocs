...
| [External OIDC Provider](#harici-oidc-sağlayıcısı) | Organizations already running an identity provider (Auth0, Authentik, Okta, Supabase, etc.) |
