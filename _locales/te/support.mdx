---
title: "మద్దతు"
description: "rtSurvey తో సహాయం పొందండి — డాక్యుమెంటేషన్, GitHub Issues మరియు కమ్యూనిటీ వనరులు."
---
...
rtSurvey ఒక ఓపెన్-సోర్స్, స్వయంగా హోస్ట్ చేయబడిన ప్లాట్‌ఫారమ్. GitHub మరియు కమ్యూనిటీ చానల్‌ల ద్వారా మద్దతు అందించబడుతుంది.
...
>
  బగ్‌లు నివేదించండి, ఫీచర్‌లు అభ్యర్థించండి లేదా తెలిసిన సమస్యలు బ్రౌజ్ చేయండి.
</FeatureCard>
...
>
  ప్రశ్నలు అడగండి మరియు కమ్యూనిటీ నుండి సహాయం పొందండి.
</FeatureCard>
...
>
  పూర్తి rtSurvey డాక్యుమెంటేషన్ బ్రౌజ్ చేయండి.
</FeatureCard>
...
>
  support+info@rta.vn వద్ద నేరుగా మాతో సంప్రదించండి.
</FeatureCard>

<FeatureCard
  title="rtSurvey వెబ్‌సైట్"
...
>
  ఉత్పత్తి సమాచారం, డెమోలు మరియు ఎంటర్‌ప్రైజ్ విచారణలు.
</FeatureCard>
...
>
  అప్‌డేట్‌లు మరియు ప్రకటనల కోసం @RtSurvey ను అనుసరించండి.
</FeatureCard>

</div>

## సమస్య తెరవడానికి ముందు

కొత్తది సృష్టించే ముందు [ఇప్పటికే ఉన్న సమస్యలు](https://github.com/therealtimex/rtsurvey/issues) వెతకండి. చేర్చండి:

- rtSurvey వెర్షన్
- డిప్లాయ్‌మెంట్ పద్ధతి (Linode StackScript, DigitalOcean, మాన్యువల్ Docker)
- పునరావృతం చేయడానికి దశలు
- సంబంధిత లాగ్‌లు (`docker compose logs`)
