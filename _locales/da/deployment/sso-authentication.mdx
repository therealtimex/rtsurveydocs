...
| Option | Best For |
|--------|----------|
| [Embedded Keycloak](#integreret-keycloak) | Organizations that want a fully self-contained SSO server bundled with rtCloud |
| [External OIDC Provider](#ekstern-oidc-udbyder) | Organizations already running an identity provider (Auth0, Authentik, Okta, Supabase, etc.) |
