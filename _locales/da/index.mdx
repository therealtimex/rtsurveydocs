...
description: "Officiel dokumentation for rtSurvey — en selvhostet platform til mobil dataindsamling og undersøgelser."
---
...
Velkommen til den officielle dokumentation for **rtSurvey** — en selvhostet platform til at designe formularer, indsamle data i felten og analysere resultater i realtid.
...
>
  Ny bruger af rtSurvey? Start her for at få et overblik over platformen.
</FeatureCard>
...
>
  Udrul på Linode, DigitalOcean eller enhver Linux-server.
</FeatureCard>
...
>
  Byg formularer med spørgsmål, logik, medier og gentagelser.
</FeatureCard>

<FeatureCard
  title="Platformgrænseflader"
...
>
  Udforsk webappen, mobilappen og webformularer.
</FeatureCard>
...
>
  GitHub Issues, fællesskabsdiskussioner og e-mail support.
</FeatureCard>
...
>
  Se kildekode, åbn issues og bidrag.
</FeatureCard>
