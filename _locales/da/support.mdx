---
title: "Support"
description: "Få hjælp med rtSurvey — dokumentation, GitHub Issues og fællesskabsressourcer."
---
...
rtSurvey er en open source, selvhostet platform. Support ydes via GitHub og fællesskabskanaler.
...
>
  Rapporter fejl, anmod om funktioner eller gennemse kendte problemer.
</FeatureCard>
...
>
  Stil spørgsmål og få hjælp fra fællesskabet.
</FeatureCard>
...
>
  Gennemse den fulde rtSurvey-dokumentation.
</FeatureCard>
...
>
  Kontakt os direkte på support+info@rta.vn.
</FeatureCard>

<FeatureCard
  title="rtSurvey Websted"
...
>
  Produktinformation, demonstrationer og virksomhedsforespørgsler.
</FeatureCard>
...
>
  Følg @RtSurvey for opdateringer og meddelelser.
</FeatureCard>

</div>

## Inden du åbner et issue

Søg venligst i [eksisterende issues](https://github.com/therealtimex/rtsurvey/issues) inden du opretter et nyt. Inkluder:

- rtSurvey-version
- Udrulningsmetode (Linode StackScript, DigitalOcean, manuel Docker)
- Trin til reproduktion
- Relevante logfiler (`docker compose logs`)
