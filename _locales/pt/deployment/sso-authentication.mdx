...
| Option | Best For |
|--------|----------|
| [Embedded Keycloak](#keycloak-incorporado) | Organizations that want a fully self-contained SSO server bundled with rtCloud |
| [External OIDC Provider](#fornecedor-oidc-externo) | Organizations already running an identity provider (Auth0, Authentik, Okta, Supabase, etc.) |
...
### Aprovisionamento Automático de Utilizadores
