...
## 2. Carregue o seu XLSForm para o rtCloud ou crie um formulário com o Construtor de Formulários (Beta)

1.  Crie uma definição de formulário usando XLSForm ou experimente este formulário [All Widgets](https://docs.google.com/spreadsheets/d/1af_Sl8A_L8_EULbhRLHVl8OclCfco09Hq2tqb9CslwQ/edit#gid=0).
2.  Carregue o seu XLSForm para o rtCloud e publique-o.

## 3. Obtenha a aplicação rtSurvey
...
## 5. Preencha o seu formulário no Collect
...
## 6. Utilize os seus dados no rtCloud
