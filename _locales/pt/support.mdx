...
>
  Reporte bugs, solicite funcionalidades ou consulte problemas conhecidos.
</FeatureCard>
...
>
  Consulte a documentação completa do rtSurvey.
</FeatureCard>
...
>
  Contacte-nos diretamente em support+info@rta.vn.
</FeatureCard>
...
>
  Informações sobre o produto, demonstrações e consultas empresariais.
</FeatureCard>
...
>
  Siga @RtSurvey para atualizações e anúncios.
</FeatureCard>
...
Por favor, pesquise [problemas existentes](https://github.com/therealtimex/rtsurvey/issues) antes de criar um novo. Inclua:

- Versão do rtSurvey
- Método de implementação (Linode StackScript, DigitalOcean, Docker manual)
