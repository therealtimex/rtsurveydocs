...
description: "Documentação oficial do rtSurvey — uma plataforma auto-hospedada de recolha de dados móveis e questionários."
---
...
Bem-vindo à documentação oficial do **rtSurvey** — uma plataforma auto-hospedada para conceber formulários, recolher dados no terreno e analisar resultados em tempo real.
...
>
  Construa formulários com perguntas, lógica, multimédia e repetições.
</FeatureCard>
...
>
  Explore a aplicação web, a aplicação móvel e o formulário web.
</FeatureCard>
