---
title: "rtSurvey Dokumentáció"
description: "Az rtSurvey hivatalos dokumentációja — egy önállóan üzemeltetett mobil adatgyűjtő és felmérési platform."
---

import FeatureCard from '../components/FeatureCard';

# rtSurvey Dokumentáció

Üdvözöljük az **rtSurvey** hivatalos dokumentációjában — egy önállóan üzemeltetett platform, amely lehetővé teszi az űrlapok tervezését, a helyszíni adatgyűjtést és az eredmények valós idejű elemzését.
...
>
  Új az rtSurvey-ben? Kezdje itt a platform áttekintésével.
</FeatureCard>
...
>
  Telepítés Linode-on, DigitalOcean-en vagy bármely Linux szerveren.
</FeatureCard>
...
>
  Építsen űrlapokat kérdésekkel, logikával, médiával és ismétlésekkel.
</FeatureCard>

<FeatureCard
  title="Platform felületek"
...
>
  Fedezze fel a webalkalmazást, a mobilalkalmazást és a webes űrlapot.
</FeatureCard>
...
>
  GitHub Issues, közösségi megbeszélések és e-mail támogatás.
</FeatureCard>
...
>
  Forráskód megtekintése, hibák bejelentése és hozzájárulás.
</FeatureCard>
