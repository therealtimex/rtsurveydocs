...
| Option | Best For |
|--------|----------|
| [Embedded Keycloak](#beágyazott-keycloak) | Organizations that want a fully self-contained SSO server bundled with rtCloud |
| [External OIDC Provider](#külső-oidc-szolgáltató) | Organizations already running an identity provider (Auth0, Authentik, Okta, Supabase, etc.) |
...
### Felhasználók automatikus kiépítése
