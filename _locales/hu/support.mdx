---
title: "Támogatás"
description: "Kérjen segítséget az rtSurvey-hez — dokumentáció, GitHub Issues és közösségi erőforrások."
---
...
Az rtSurvey egy nyílt forráskódú, önállóan üzemeltetett platform. A támogatás GitHub-on és közösségi csatornákon keresztül érhető el.
...
>
  Jelentsen hibákat, kérjen funkciókat vagy böngésszen az ismert problémák között.
</FeatureCard>
...
>
  Tegyen fel kérdéseket és kapjon segítséget a közösségtől.
</FeatureCard>
...
>
  Böngésszen a teljes rtSurvey dokumentációban.
</FeatureCard>
...
>
  Lépjen kapcsolatba velünk közvetlenül a support+info@rta.vn címen.
</FeatureCard>

<FeatureCard
  title="rtSurvey weboldal"
...
>
  Termékinformációk, bemutatók és vállalati megkeresések.
</FeatureCard>
...
>
  Kövesse a @RtSurvey-t frissítésekért és bejelentésekért.
</FeatureCard>

</div>

## Probléma megnyitása előtt

Kérjük, keressen a [meglévő problémák](https://github.com/therealtimex/rtsurvey/issues) között, mielőtt újat hozna létre. Adja meg:

- rtSurvey verziója
- Telepítési módszer (Linode StackScript, DigitalOcean, manuális Docker)
- A reprodukálás lépései
- Releváns naplók (`docker compose logs`)
