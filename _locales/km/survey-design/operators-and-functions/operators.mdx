...
ឧទាហរណ៍ ១:
<Callout type="info">`${age} = 3 or ${age} = 4` ត ្ រ ឡ ប ់ `true` ប ្ រ ស ិ ន ប ើ age ជ ា 3 ឬ 4 ។</Callout>

ឧទាហរណ៍ ២:
<Callout type="info">`${age} > 3 and ${age} < 5` ត ្ រ ឡ ប ់ `true` ប ្ រ ស ិ ន ប ើ age ន ៅ ចន ្ ល ោ ះ 3 ហ ើ យ 5 ។</Callout>

ឧទាហរណ៍ ៣:
<Callout type="info">`not(${age} > 3 and ${age} < 5)` ត ្ រ ឡ ប ់ `true` ប ្ រ ស ិ ន ប ើ age ន ៅ ក ្ រ ោ យ range ។</Callout>
