...
Exempel 1:
<Callout type="info">`${age} = 3 or ${age} = 4` returnerar `true` om åldern är antingen 3 eller 4.</Callout>

Exempel 2:
<Callout type="info">`${age} > 3 and ${age} < 5` returnerar `true` om åldern är mellan 3 och 5.</Callout>

Exempel 3:
<Callout type="info">`not(${age} > 3 and ${age} < 5)` returnerar `true` om åldern inte är mellan 3 och 5.</Callout>
