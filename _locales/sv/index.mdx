...
description: "Officiell dokumentation för rtSurvey — en självhostad plattform för mobil datainsamling och enkäter."
---
...
Välkommen till den officiella dokumentationen för **rtSurvey** — en självhostad plattform för att designa formulär, samla in data i fält och analysera resultat i realtid.
...
>
  Ny på rtSurvey? Börja här för en plattformsöversikt.
</FeatureCard>
...
>
  Driftsätt på Linode, DigitalOcean eller valfri Linux-server.
</FeatureCard>
...
>
  Bygg formulär med frågor, logik, media och upprepningar.
</FeatureCard>

<FeatureCard
  title="Plattformsgränssnitt"
...
>
  Utforska webbappen, mobilappen och webbformuläret.
</FeatureCard>
...
>
  GitHub Issues, gemenskapsdiskussioner och e-postsupport.
</FeatureCard>
...
>
  Visa källkod, öppna ärenden och bidra.
</FeatureCard>
