...
| Option | Best For |
|--------|----------|
| [Embedded Keycloak](#inbyggd-keycloak) | Organizations that want a fully self-contained SSO server bundled with rtCloud |
| [External OIDC Provider](#extern-oidc-leverantör) | Organizations already running an identity provider (Auth0, Authentik, Okta, Supabase, etc.) |
