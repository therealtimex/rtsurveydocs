---
title: "Support"
description: "Få hjälp med rtSurvey — dokumentation, GitHub Issues och gemenskapsresurser."
---
...
rtSurvey är en öppen källkod, självhostad plattform. Support ges via GitHub och gemenskapskanaler.
...
>
  Rapportera buggar, begär funktioner eller bläddra bland kända problem.
</FeatureCard>
...
>
  Ställ frågor och få hjälp från gemenskapen.
</FeatureCard>
...
>
  Bläddra i den fullständiga rtSurvey-dokumentationen.
</FeatureCard>
...
>
  Kontakta oss direkt på support+info@rta.vn.
</FeatureCard>

<FeatureCard
  title="rtSurvey Webbplats"
...
>
  Produktinformation, demonstrationer och enterprise-förfrågningar.
</FeatureCard>
...
>
  Följ @RtSurvey för uppdateringar och meddelanden.
</FeatureCard>
...
Sök bland [befintliga ärenden](https://github.com/therealtimex/rtsurvey/issues) innan du skapar ett nytt. Inkludera:

- rtSurvey-version
- Driftsättningsmetod (Linode StackScript, DigitalOcean, manuell Docker)
- Steg för att reproducera
- Relevanta loggar (`docker compose logs`)
