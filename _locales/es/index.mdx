---
title: "Documentación de rtSurvey"
description: "Documentación oficial de rtSurvey — una plataforma autoalojada de recopilación de datos móvil y encuestas."
---

import FeatureCard from '../components/FeatureCard';

# Documentación de rtSurvey

Bienvenido a la documentación oficial de **rtSurvey** — una plataforma autoalojada para diseñar formularios, recopilar datos en el campo y analizar resultados en tiempo real.
...
>
  ¿Nuevo en rtSurvey? Empiece aquí para obtener una descripción general de la plataforma.
</FeatureCard>
...
>
  Despliegue en Linode, DigitalOcean o cualquier servidor Linux.
</FeatureCard>
...
>
  Construya formularios con preguntas, lógica, multimedia y repeticiones.
</FeatureCard>

<FeatureCard
  title="Interfaces de la Plataforma"
...
>
  Explore la aplicación web, la aplicación móvil y el formulario web.
</FeatureCard>
...
>
  GitHub Issues, debates comunitarios y soporte por correo electrónico.
</FeatureCard>
...
>
  Ver el código fuente, abrir issues y contribuir.
</FeatureCard>
