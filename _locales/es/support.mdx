---
title: "Soporte"
description: "Obtenga ayuda con rtSurvey — documentación, GitHub Issues y recursos comunitarios."
---
...
rtSurvey es una plataforma de código abierto y autoalojada. El soporte se proporciona a través de GitHub y canales comunitarios.
...
>
  Reporte errores, solicite funciones o explore problemas conocidos.
</FeatureCard>
...
>
  Haga preguntas y obtenga ayuda de la comunidad.
</FeatureCard>
...
>
  Explore la documentación completa de rtSurvey.
</FeatureCard>
...
>
  Contáctenos directamente en support+info@rta.vn.
</FeatureCard>

<FeatureCard
  title="Sitio Web de rtSurvey"
...
>
  Información del producto, demostraciones y consultas empresariales.
</FeatureCard>
...
>
  Siga a @RtSurvey para actualizaciones y anuncios.
</FeatureCard>
...
Busque en los [issues existentes](https://github.com/therealtimex/rtsurvey/issues) antes de crear uno nuevo. Incluya:

- Versión de rtSurvey
- Método de despliegue (Linode StackScript, DigitalOcean, Docker manual)
- Pasos para reproducir
- Registros relevantes (`docker compose logs`)
