---
title: "Підтримка"
description: "Отримайте допомогу з rtSurvey — документація, GitHub Issues та ресурси спільноти."
---
...
rtSurvey — це платформа з відкритим кодом із самостійним розгортанням. Підтримка надається через GitHub та канали спільноти.
...
>
  Повідомляйте про помилки, запитуйте функції або переглядайте відомі проблеми.
</FeatureCard>
...
>
  Задавайте питання та отримуйте допомогу від спільноти.
</FeatureCard>
...
>
  Перегляньте повну документацію rtSurvey.
</FeatureCard>
...
>
  Зверніться до нас безпосередньо на support+info@rta.vn.
</FeatureCard>

<FeatureCard
  title="Вебсайт rtSurvey"
...
>
  Інформація про продукт, демонстрації та корпоративні запити.
</FeatureCard>
...
>
  Стежте за @RtSurvey для отримання оновлень та оголошень.
</FeatureCard>

</div>

## Перед відкриттям задачі

Будь ласка, знайдіть [існуючі задачі](https://github.com/therealtimex/rtsurvey/issues) перед створенням нової. Вкажіть:

- Версію rtSurvey
- Метод розгортання (Linode StackScript, DigitalOcean, ручний Docker)
- Кроки для відтворення
- Відповідні журнали (`docker compose logs`)
