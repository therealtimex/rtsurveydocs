...
| [External OIDC Provider](#зовнішній-oidc-провайдер) | Organizations already running an identity provider (Auth0, Authentik, Okta, Supabase, etc.) |
