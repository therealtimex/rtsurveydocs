---
title: "Документація rtSurvey"
description: "Офіційна документація для rtSurvey — самостійно розгорнута платформа для мобільного збору даних та опитувань."
---

import FeatureCard from '../components/FeatureCard';

# Документація rtSurvey

Ласкаво просимо до офіційної документації **rtSurvey** — самостійно розгорнутої платформи для розробки форм, збору даних у полі та аналізу результатів у реальному часі.
...
>
  Вперше з rtSurvey? Почніть тут для огляду платформи.
</FeatureCard>
...
>
  Розгорніть на Linode, DigitalOcean або будь-якому сервері Linux.
</FeatureCard>

<FeatureCard
  title="Дизайн опитувань"
...
>
  Створюйте форми з питаннями, логікою, медіа та повторами.
</FeatureCard>

<FeatureCard
  title="Інтерфейси платформи"
...
>
  Ознайомтеся з веб-додатком, мобільним додатком та веб-формою.
</FeatureCard>
...
>
  GitHub Issues, обговорення спільноти та підтримка електронною поштою.
</FeatureCard>
...
>
  Перегляньте код, відкривайте задачі та робіть внески.
</FeatureCard>
