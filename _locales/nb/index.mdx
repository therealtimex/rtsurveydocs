---
title: "rtSurvey dokumentasjon"
description: "Offisiell dokumentasjon for rtSurvey — en selvdriftet mobilbasert datainnsamlings- og undersøkelsesplattform."
---

import FeatureCard from '../components/FeatureCard';

# rtSurvey dokumentasjon

Velkommen til den offisielle dokumentasjonen for **rtSurvey** — en selvdriftet plattform for skjemadesign, feltdatainnsamling og sanntidsanalyse av resultater.
...
>
  Ny med rtSurvey? Start her for en plattformoversikt.
</FeatureCard>
...
>
  Distribuer på Linode, DigitalOcean eller en hvilken som helst Linux-server.
</FeatureCard>

<FeatureCard
  title="Undersøkelsesdesign"
...
>
  Bygg skjemaer med spørsmål, logikk, medier og gjentakelser.
</FeatureCard>

<FeatureCard
  title="Plattformgrensesnitt"
...
>
  Utforsk nettappen, mobilappen og nettskjemaet.
</FeatureCard>
...
>
  GitHub Issues, fellesskapsdiskusjoner og e-poststøtte.
</FeatureCard>
...
>
  Se kildekode, åpne saker og bidra.
</FeatureCard>
