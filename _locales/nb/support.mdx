---
title: "Støtte"
description: "Få hjelp med rtSurvey — dokumentasjon, GitHub Issues og fellesskapsressurser."
---
...
rtSurvey er en åpen kildekode, selvdriftet plattform. Støtte gis gjennom GitHub og fellesskapskanaler.
...
>
  Rapporter feil, be om funksjoner eller bla gjennom kjente problemer.
</FeatureCard>
...
>
  Still spørsmål og få hjelp fra fellesskapet.
</FeatureCard>
...
>
  Bla gjennom hele rtSurvey-dokumentasjonen.
</FeatureCard>
...
>
  Kontakt oss direkte på support+info@rta.vn.
</FeatureCard>

<FeatureCard
  title="rtSurvey nettsted"
...
>
  Produktinformasjon, demoer og bedriftsforespørsler.
</FeatureCard>
...
>
  Følg @RtSurvey for oppdateringer og kunngjøringer.
</FeatureCard>
...
Vennligst søk gjennom [eksisterende saker](https://github.com/therealtimex/rtsurvey/issues) før du oppretter en ny. Inkluder:

- rtSurvey-versjon
- Distribusjonsmetode (Linode StackScript, DigitalOcean, manuell Docker)
- Trinn for å reprodusere
- Relevante logger (`docker compose logs`)
