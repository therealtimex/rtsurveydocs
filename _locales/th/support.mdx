---
title: "การสนับสนุน"
description: "รับความช่วยเหลือกับ rtSurvey — เอกสาร GitHub Issues และทรัพยากรชุมชน"
---
...
rtSurvey เป็นแพลตฟอร์มโอเพนซอร์สแบบโฮสต์เอง การสนับสนุนจัดทำผ่าน GitHub และช่องทางชุมชน
...
>
  รายงานบั๊ก ขอฟีเจอร์ หรือดูปัญหาที่ทราบแล้ว
</FeatureCard>
...
>
  ถามคำถามและรับความช่วยเหลือจากชุมชน
</FeatureCard>
...
>
  เรียกดูเอกสาร rtSurvey ฉบับสมบูรณ์
</FeatureCard>
...
>
  ติดต่อเราโดยตรงที่ support+info@rta.vn
</FeatureCard>

<FeatureCard
  title="เว็บไซต์ rtSurvey"
...
>
  ข้อมูลผลิตภัณฑ์ การสาธิต และการสอบถามระดับองค์กร
</FeatureCard>
...
>
  ติดตาม @RtSurvey สำหรับการอัปเดตและประกาศ
</FeatureCard>
...
โปรดค้นหา[ประเด็นที่มีอยู่](https://github.com/therealtimex/rtsurvey/issues)ก่อนสร้างใหม่ รวมถึง:

- เวอร์ชัน rtSurvey
- วิธีการติดตั้ง (Linode StackScript, DigitalOcean, Docker แบบกำหนดเอง)
- ขั้นตอนในการทำซ้ำ
- บันทึกที่เกี่ยวข้อง (`docker compose logs`)
