---
title: "เอกสาร rtSurvey"
description: "เอกสารอย่างเป็นทางการสำหรับ rtSurvey — แพลตฟอร์มการเก็บข้อมูลมือถือและแบบสำรวจแบบโฮสต์เอง"
---
...
ยินดีต้อนรับสู่เอกสารอย่างเป็นทางการสำหรับ **rtSurvey** — แพลตฟอร์มแบบโฮสต์เองสำหรับการออกแบบแบบฟอร์ม การเก็บข้อมูลในสนาม และการวิเคราะห์ผลลัพธ์แบบเรียลไทม์
...
>
  ใหม่กับ rtSurvey? เริ่มต้นที่นี่เพื่อดูภาพรวมของแพลตฟอร์ม
</FeatureCard>
...
>
  ติดตั้งบน Linode, DigitalOcean หรือเซิร์ฟเวอร์ Linux ใดก็ได้
</FeatureCard>
...
>
  สร้างแบบฟอร์มพร้อมคำถาม ตรรกะ สื่อ และการทำซ้ำ
</FeatureCard>

<FeatureCard
  title="อินเทอร์เฟซแพลตฟอร์ม"
...
>
  สำรวจเว็บแอป แอปมือถือ และเว็บฟอร์ม
</FeatureCard>
...
>
  GitHub Issues การสนทนาในชุมชน และการสนับสนุนทางอีเมล
</FeatureCard>
...
>
  ดูซอร์สโค้ด เปิดประเด็น และมีส่วนร่วม
</FeatureCard>
