---
title: "Atbalsts"
description: "Saņemiet palīdzību ar rtSurvey — dokumentācija, GitHub Issues un kopienas resursi."
---
...
rtSurvey ir atvērtā pirmkoda pašmitināta platforma. Atbalsts tiek sniegts caur GitHub un kopienas kanāliem.
...
>
  Ziņojiet par kļūdām, pieprasiet funkcijas vai pārlūkojiet zināmās problēmas.
</FeatureCard>
...
>
  Uzdodiet jautājumus un saņemiet palīdzību no kopienas.
</FeatureCard>
...
>
  Pārlūkojiet pilnu rtSurvey dokumentāciju.
</FeatureCard>
...
>
  Sazinieties ar mums tieši uz support+info@rta.vn.
</FeatureCard>

<FeatureCard
  title="rtSurvey tīmekļa vietne"
...
>
  Produkta informācija, demonstrācijas un uzņēmumu pieprasījumi.
</FeatureCard>
...
>
  Sekojiet @RtSurvey jaunumiem un paziņojumiem.
</FeatureCard>

</div>

## Pirms problēmas atvēršanas

Lūdzu, meklējiet [esošās problēmas](https://github.com/therealtimex/rtsurvey/issues) pirms jaunas izveidošanas. Iekļaujiet:

- rtSurvey versiju
- Izvietošanas metodi (Linode StackScript, DigitalOcean, manuālais Docker)
- Atkārtošanas soļus
- Attiecīgos žurnālus (`docker compose logs`)
