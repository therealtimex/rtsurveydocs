---
title: "rtSurvey dokumentācija"
description: "Oficiālā rtSurvey dokumentācija — pašmitināta mobilās datu vākšanas un aptauju platforma."
---

import FeatureCard from '../components/FeatureCard';

# rtSurvey dokumentācija

Laipni lūdzam oficiālajā **rtSurvey** dokumentācijā — pašmitinātā platformā formu veidošanai, datu vākšanai laukā un rezultātu analīzei reāllaikā.
...
>
  Izmantojat rtSurvey pirmo reizi? Sāciet šeit, lai iegūtu platformas pārskatu.
</FeatureCard>
...
>
  Izvietojiet Linode, DigitalOcean vai jebkurā Linux serverī.
</FeatureCard>

<FeatureCard
  title="Aptauju izstrāde"
...
>
  Veidojiet formas ar jautājumiem, loģiku, multividi un atkārtojumiem.
</FeatureCard>

<FeatureCard
  title="Platformas saskarnes"
...
>
  Izpētiet tīmekļa lietotni, mobilās lietotni un tīmekļa veidlapu.
</FeatureCard>
...
>
  GitHub Issues, kopienas diskusijas un e-pasta atbalsts.
</FeatureCard>
...
>
  Skatīt avotu, atvērt problēmas un sniegt ieguldījumu.
</FeatureCard>
