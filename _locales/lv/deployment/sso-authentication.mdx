...
| Option | Best For |
|--------|----------|
| [Embedded Keycloak](#iebūvētais-keycloak) | Organizations that want a fully self-contained SSO server bundled with rtCloud |
| [External OIDC Provider](#ārējais-oidc-nodrošinātājs) | Organizations already running an identity provider (Auth0, Authentik, Okta, Supabase, etc.) |
...
### Lietotāju automātiskā nodrošināšana
