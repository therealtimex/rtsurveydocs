---
title: "サポート"
description: "rtSurvey のヘルプを取得 — ドキュメント、GitHub Issues、コミュニティリソース。"
---
...
rtSurvey はオープンソースのセルフホスト型プラットフォームです。GitHub およびコミュニティチャンネルを通じてサポートを提供しています。
...
>
  support+info@rta.vn まで直接お問い合わせください。
</FeatureCard>

<FeatureCard
  title="rtSurvey ウェブサイト"
...
>
  @RtSurvey をフォローして最新情報をお受け取りください。
</FeatureCard>
...
新しい Issue を作成する前に、[既存の Issue](https://github.com/therealtimex/rtsurvey/issues) を検索してください。以下を含めてください：

- rtSurvey のバージョン
- デプロイ方法（Linode StackScript、DigitalOcean、手動 Docker）
- 再現手順
- 関連するログ（`docker compose logs`）
