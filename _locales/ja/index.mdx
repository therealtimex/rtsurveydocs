---
title: "rtSurvey ドキュメント"
description: "rtSurvey の公式ドキュメント — セルフホスト型モバイルデータ収集・アンケートプラットフォーム。"
---
...
**rtSurvey** の公式ドキュメントへようこそ。フォームの設計、フィールドでのデータ収集、リアルタイムでの結果分析ができるセルフホスト型プラットフォームです。
...
>
  rtSurvey が初めての方はこちらから。プラットフォームの概要をご確認ください。
</FeatureCard>
...
>
  Linode、DigitalOcean、または任意の Linux サーバーにデプロイできます。
</FeatureCard>
...
>
  質問、ロジック、メディア、繰り返しを使ったフォームを作成できます。
</FeatureCard>

<FeatureCard
  title="プラットフォームインターフェース"
...
>
  GitHub Issues、コミュニティディスカッション、メールサポート。
</FeatureCard>
