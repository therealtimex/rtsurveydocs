...
| Option | Best For |
|--------|----------|
| [Embedded Keycloak](#組み込み-keycloak) | Organizations that want a fully self-contained SSO server bundled with rtCloud |
| [External OIDC Provider](#外部-oidc-プロバイダー) | Organizations already running an identity provider (Auth0, Authentik, Okta, Supabase, etc.) |
