---
title: "支援"
description: "取得 rtSurvey 的協助 — 文件、GitHub Issues 和社群資源。"
---
...
rtSurvey 是一個開源自托管平台。支援透過 GitHub 和社群管道提供。
...
請在建立新 Issue 前搜尋[現有 Issues](https://github.com/therealtimex/rtsurvey/issues)。請包含：

- rtSurvey 版本
- 部署方式（Linode StackScript、DigitalOcean、手動 Docker）
- 重現步驟
- 相關日誌（`docker compose logs`）
