---
title: "rtSurvey 文件"
description: "rtSurvey 官方文件 — 自托管行動資料收集與問卷調查平台。"
---
...
歡迎閱讀 **rtSurvey** 官方文件 — 一個用於設計表單、現場資料收集和即時分析結果的自托管平台。
...
>
  在 Linode、DigitalOcean 或任何 Linux 伺服器上部署。
</FeatureCard>
