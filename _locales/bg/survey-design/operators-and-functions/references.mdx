...
## `..` — Препратка към родителска група
...
## Препратка към стойности в групи за повторение
...
## Принудително преобразуване на типове в препратки
