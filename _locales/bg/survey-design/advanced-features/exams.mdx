...
### Стъпка 1: Добавяне на полета за изпит
...
### Стъпка 3: Съхраняване на оставащото време
...
## Изключване на въпроси от таймера
