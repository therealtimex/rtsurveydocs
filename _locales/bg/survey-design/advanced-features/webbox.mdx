...
## Предаване на стойности от формуляра към вградената страница
...
## Взаимодействие с повторения: бутони за изтриване
...
## Комуникация с вградената страница (postMessage)
