...
## Текуща позиция на екземпляра: `index()`
...
## Препратка към полета в същия екземпляр
...
## Препратка към родителски полета от вътрешността на повторение
...
## Класиране в групи за повторение: `rank-index()`
