...
## Разширения за въвеждане на час в rtSurvey
...
### Пример: Запис на продължителност на задача в минути и секунди

| type | name | label | appearance |
|------|------|-------|------------|
| text | task_duration | Time taken to complete the task | `inline-[%M:%S]` |

### Пример: Запис на час на събитие в 24-часов формат с персонализиран цвят
