...
| Option | Best For |
|--------|----------|
| [Embedded Keycloak](#вграден-keycloak) | Organizations that want a fully self-contained SSO server bundled with rtCloud |
| [External OIDC Provider](#външен-oidc-доставчик) | Organizations already running an identity provider (Auth0, Authentik, Okta, Supabase, etc.) |
