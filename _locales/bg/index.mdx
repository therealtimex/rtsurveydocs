---
title: "Документация на rtSurvey"
description: "Официална документация за rtSurvey — самостоятелно хоствана платформа за мобилно събиране на данни и анкети."
---

import FeatureCard from '../components/FeatureCard';

# Документация на rtSurvey

Добре дошли в официалната документация за **rtSurvey** — самостоятелно хоствана платформа за проектиране на форми, събиране на данни на терен и анализиране на резултати в реално време.
...
>
  Нов потребител на rtSurvey? Започнете оттук, за да получите общ преглед на платформата.
</FeatureCard>
...
>
  Разгърнете на Linode, DigitalOcean или всеки Linux сървър.
</FeatureCard>
...
>
  Създавайте форми с въпроси, логика, медия и повторения.
</FeatureCard>

<FeatureCard
  title="Интерфейси на платформата"
...
>
  Разгледайте уеб приложението, мобилното приложение и уеб форми.
</FeatureCard>
...
>
  GitHub Issues, общностни дискусии и имейл поддръжка.
</FeatureCard>
...
>
  Вижте изходния код, отворете issues и допринасяйте.
</FeatureCard>
