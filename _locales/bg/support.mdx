---
title: "Поддръжка"
description: "Получете помощ с rtSurvey — документация, GitHub Issues и общностни ресурси."
---
...
rtSurvey е платформа с отворен код, самостоятелно хоствана. Поддръжката се предоставя чрез GitHub и общностни канали.
...
>
  Докладвайте грешки, заявявайте функции или разглеждайте известни проблеми.
</FeatureCard>
...
>
  Задавайте въпроси и получавайте помощ от общността.
</FeatureCard>
...
>
  Разгледайте пълната документация на rtSurvey.
</FeatureCard>
...
>
  Свържете се с нас директно на support+info@rta.vn.
</FeatureCard>

<FeatureCard
  title="Уебсайт на rtSurvey"
...
>
  Информация за продукта, демонстрации и корпоративни запитвания.
</FeatureCard>
...
>
  Следвайте @RtSurvey за актуализации и съобщения.
</FeatureCard>

</div>

## Преди да отворите issue

Моля, търсете в [съществуващите issues](https://github.com/therealtimex/rtsurvey/issues) преди да създадете нов. Включете:

- Версия на rtSurvey
- Метод на разгръщане (Linode StackScript, DigitalOcean, ръчен Docker)
- Стъпки за възпроизвеждане
- Съответни логове (`docker compose logs`)
