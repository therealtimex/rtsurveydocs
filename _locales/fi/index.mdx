---
title: "rtSurvey-dokumentaatio"
description: "Virallinen dokumentaatio rtSurveylle — itse isännöity mobiilitiedonkeruu- ja kyselyalusta."
---

import FeatureCard from '../components/FeatureCard';

# rtSurvey-dokumentaatio

Tervetuloa **rtSurveyn** viralliseen dokumentaatioon — itse isännöity alusta lomakkeiden suunnitteluun, tietojen keräämiseen kentällä ja tulosten analysointiin reaaliajassa.
...
>
  Uusi rtSurveyssa? Aloita täältä saadaksesi yleiskatsauksen alustasta.
</FeatureCard>
...
>
  Ota käyttöön Linodella, DigitalOceanilla tai millä tahansa Linux-palvelimella.
</FeatureCard>
...
>
  Rakenna lomakkeita kysymyksillä, logiikalla, medialla ja toistoilla.
</FeatureCard>

<FeatureCard
  title="Alustan käyttöliittymät"
...
>
  Tutustu verkkosovellukseen, mobiilisovellukseen ja verkkolomakkeeseen.
</FeatureCard>
...
>
  GitHub Issues, yhteisökeskustelut ja sähköpostituki.
</FeatureCard>
...
>
  Katso lähdekoodi, avaa issueita ja osallistu kehitykseen.
</FeatureCard>
