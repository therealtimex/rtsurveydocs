...
| Option | Best For |
|--------|----------|
| [Embedded Keycloak](#sisäänrakennettu-keycloak) | Organizations that want a fully self-contained SSO server bundled with rtCloud |
| [External OIDC Provider](#ulkoinen-oidc-palveluntarjoaja) | Organizations already running an identity provider (Auth0, Authentik, Okta, Supabase, etc.) |
...
## Ulkoinen OIDC-palveluntarjoaja
