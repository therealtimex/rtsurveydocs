---
title: "Tuki"
description: "Hanki apua rtSurveylle — dokumentaatio, GitHub Issues ja yhteisöresurssit."
---
...
rtSurvey on avoimen lähdekoodin, itse isännöity alusta. Tuki tarjotaan GitHubin ja yhteisökanavien kautta.
...
>
  Ilmoita vioista, pyydä ominaisuuksia tai selaa tunnettuja ongelmia.
</FeatureCard>
...
>
  Esitä kysymyksiä ja hanki apua yhteisöltä.
</FeatureCard>
...
>
  Selaa koko rtSurvey-dokumentaatiota.
</FeatureCard>
...
>
  Ota meihin suoraan yhteyttä osoitteessa support+info@rta.vn.
</FeatureCard>

<FeatureCard
  title="rtSurvey-verkkosivusto"
...
>
  Tuotetiedot, esittelyt ja yrityskyselyt.
</FeatureCard>
...
>
  Seuraa @RtSurveyta päivityksistä ja ilmoituksista.
</FeatureCard>

</div>

## Ennen issuen avaamista

Etsi [olemassa olevista issuista](https://github.com/therealtimex/rtsurvey/issues) ennen uuden luomista. Sisällytä:

- rtSurvey-versio
- Käyttöönottomenetelmä (Linode StackScript, DigitalOcean, manuaalinen Docker)
- Toistamisvaiheet
- Asiaankuuluvat lokit (`docker compose logs`)
