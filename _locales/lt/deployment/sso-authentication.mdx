...
| Option | Best For |
|--------|----------|
| [Embedded Keycloak](#integruotas-keycloak) | Organizations that want a fully self-contained SSO server bundled with rtCloud |
| [External OIDC Provider](#išorinis-oidc-tiekėjas) | Organizations already running an identity provider (Auth0, Authentik, Okta, Supabase, etc.) |
...
### Kas yra iš anksto sukonfigūruota
...
### Automatinis naudotojų suteikimas
...
### Pasirinktiniai galutiniai taškai
