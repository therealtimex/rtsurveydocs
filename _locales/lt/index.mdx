---
title: "rtSurvey dokumentacija"
description: "Oficiali rtSurvey dokumentacija — savarankiškai talpinama mobilių duomenų rinkimo ir apklausų platforma."
---

import FeatureCard from '../components/FeatureCard';

# rtSurvey dokumentacija

Sveiki atvykę į oficialią **rtSurvey** dokumentaciją — savarankiškai talpinamą platformą formų projektavimui, duomenų rinkimui lauke ir rezultatų analizei realiuoju laiku.
...
>
  Pirmą kartą naudojate rtSurvey? Pradėkite čia norėdami gauti platformos apžvalgą.
</FeatureCard>
...
>
  Diekite „Linode", „DigitalOcean" arba bet kuriame Linux serveryje.
</FeatureCard>

<FeatureCard
  title="Apklausų projektavimas"
...
>
  Kurkite formas su klausimais, logika, medija ir pasikartojimais.
</FeatureCard>

<FeatureCard
  title="Platformos sąsajos"
...
>
  Tyrinėkite žiniatinklio programą, mobilią programą ir žiniatinklio formą.
</FeatureCard>
...
>
  GitHub Issues, bendruomenės diskusijos ir palaikymas el. paštu.
</FeatureCard>
...
>
  Peržiūrėkite šaltinį, atidarykite problemas ir prisidėkite.
</FeatureCard>
