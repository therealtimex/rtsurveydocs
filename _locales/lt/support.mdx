---
title: "Palaikymas"
description: "Gaukite pagalbą su rtSurvey — dokumentacija, GitHub Issues ir bendruomenės ištekliai."
---
...
rtSurvey yra atvirojo kodo savarankiškai talpinama platforma. Palaikymas teikiamas per GitHub ir bendruomenės kanalus.
...
>
  Pranešti apie klaidas, prašyti funkcijų arba naršyti žinomas problemas.
</FeatureCard>
...
>
  Užduokite klausimus ir gaukite pagalbą iš bendruomenės.
</FeatureCard>
...
>
  Naršykite visą rtSurvey dokumentaciją.
</FeatureCard>

<FeatureCard
  title="Palaikymas el. paštu"
...
>
  Susisiekite su mumis tiesiogiai adresu support+info@rta.vn.
</FeatureCard>

<FeatureCard
  title="rtSurvey svetainė"
...
>
  Produkto informacija, demonstracijos ir verslo užklausos.
</FeatureCard>
...
>
  Sekite @RtSurvey naujienoms ir pranešimams.
</FeatureCard>

</div>

## Prieš atidarant problemą

Prieš kuriant naują problemą, ieškokite [esamų problemų](https://github.com/therealtimex/rtsurvey/issues). Įtraukite:

- rtSurvey versiją
- Diegimo metodą (Linode StackScript, DigitalOcean, rankinis Docker)
- Atkūrimo veiksmus
- Susijusius žurnalus (`docker compose logs`)
