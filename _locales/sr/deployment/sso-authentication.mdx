...
| Option | Best For |
|--------|----------|
| [Embedded Keycloak](#ugrađeni-keycloak) | Organizations that want a fully self-contained SSO server bundled with rtCloud |
| [External OIDC Provider](#eksterni-oidc-provajder) | Organizations already running an identity provider (Auth0, Authentik, Okta, Supabase, etc.) |
...
### Automatsko dodeljivanje korisnika
