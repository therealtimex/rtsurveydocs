...
description: "Zvanična dokumentacija za rtSurvey — platforma za mobilno prikupljanje podataka i ankete koja se samo-hostuje."
---
...
Dobrodošli u zvaničnu dokumentaciju za **rtSurvey** — platforma koja se samo-hostuje za dizajniranje formulara, prikupljanje podataka na terenu i analizu rezultata u realnom vremenu.
...
>
  Novi u rtSurvey? Počnite ovde za pregled platforme.
</FeatureCard>
...
>
  Postavite na Linode, DigitalOcean, ili bilo koji Linux server.
</FeatureCard>
...
>
  Pravite formulare sa pitanjima, logikom, medijima i ponavljanjima.
</FeatureCard>

<FeatureCard
  title="Interfejsi Platforme"
...
>
  Istražite web aplikaciju, mobilnu aplikaciju i web formu.
</FeatureCard>
...
>
  GitHub Issues, diskusije zajednice i podrška putem e-pošte.
</FeatureCard>
...
>
  Pregledajte izvorni kod, otvorite probleme i doprinesite.
</FeatureCard>
