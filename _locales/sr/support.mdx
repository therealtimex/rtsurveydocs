---
title: "Podrška"
description: "Dobijte pomoć sa rtSurvey — dokumentacija, GitHub Issues i resursi zajednice."
---
...
rtSurvey je platforma otvorenog koda koja se samo-hostuje. Podrška se pruža putem GitHub-a i kanala zajednice.
...
>
  Prijavite greške, zatražite funkcije ili pregledajte poznate probleme.
</FeatureCard>
...
>
  Postavljajte pitanja i dobijajte pomoć od zajednice.
</FeatureCard>
...
>
  Pregledajte kompletnu rtSurvey dokumentaciju.
</FeatureCard>

<FeatureCard
  title="E-poštanska Podrška"
...
>
  Kontaktirajte nas direktno na support+info@rta.vn.
</FeatureCard>

<FeatureCard
  title="rtSurvey Veb Sajt"
...
>
  Informacije o proizvodu, demonstracije i enterprise upiti.
</FeatureCard>
...
>
  Pratite @RtSurvey za ažuriranja i obaveštenja.
</FeatureCard>

</div>

## Pre Otvaranja Problema

Pretražite [postojeće probleme](https://github.com/therealtimex/rtsurvey/issues) pre nego što kreirate novi. Uključite:

- Verzija rtSurvey
- Metoda postavljanja (Linode StackScript, DigitalOcean, ručni Docker)
- Koraci za reprodukciju
- Relevantni logovi (`docker compose logs`)
