---
title: "Υποστήριξη"
description: "Λάβετε βοήθεια με το rtSurvey — τεκμηρίωση, GitHub Issues και πόρους κοινότητας."
---
...
Το rtSurvey είναι μια πλατφόρμα ανοικτού κώδικα, αυτο-φιλοξενούμενη. Η υποστήριξη παρέχεται μέσω GitHub και καναλιών κοινότητας.
...
>
  Αναφέρετε σφάλματα, ζητήστε λειτουργίες ή περιηγηθείτε σε γνωστά προβλήματα.
</FeatureCard>
...
>
  Κάντε ερωτήσεις και λάβετε βοήθεια από την κοινότητα.
</FeatureCard>
...
>
  Περιηγηθείτε στην πλήρη τεκμηρίωση του rtSurvey.
</FeatureCard>
...
>
  Επικοινωνήστε μαζί μας απευθείας στο support+info@rta.vn.
</FeatureCard>

<FeatureCard
  title="Ιστότοπος rtSurvey"
...
>
  Πληροφορίες προϊόντος, επιδείξεις και εταιρικές ερωτήσεις.
</FeatureCard>
...
>
  Ακολουθήστε το @RtSurvey για ενημερώσεις και ανακοινώσεις.
</FeatureCard>

</div>

## Πριν Ανοίξετε ένα Issue

Παρακαλούμε αναζητήστε [υπάρχοντα issues](https://github.com/therealtimex/rtsurvey/issues) πριν δημιουργήσετε ένα νέο. Συμπεριλάβετε:

- Έκδοση rtSurvey
- Μέθοδος ανάπτυξης (Linode StackScript, DigitalOcean, manual Docker)
- Βήματα για αναπαραγωγή
- Σχετικά αρχεία καταγραφής (`docker compose logs`)
