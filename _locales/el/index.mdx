---
title: "Τεκμηρίωση rtSurvey"
description: "Επίσημη τεκμηρίωση για το rtSurvey — μια αυτο-φιλοξενούμενη πλατφόρμα κινητής συλλογής δεδομένων και ερευνών."
---
...
Καλώς ορίσατε στην επίσημη τεκμηρίωση για το **rtSurvey** — μια αυτο-φιλοξενούμενη πλατφόρμα για σχεδιασμό φορμών, συλλογή δεδομένων στο πεδίο και ανάλυση αποτελεσμάτων σε πραγματικό χρόνο.
...
>
  Νέος στο rtSurvey; Ξεκινήστε εδώ για μια επισκόπηση της πλατφόρμας.
</FeatureCard>
...
>
  Αναπτύξτε σε Linode, DigitalOcean ή οποιονδήποτε διακομιστή Linux.
</FeatureCard>
...
>
  Δημιουργήστε φόρμες με ερωτήσεις, λογική, πολυμέσα και επαναλήψεις.
</FeatureCard>

<FeatureCard
  title="Διεπαφές Πλατφόρμας"
...
>
  Εξερευνήστε την εφαρμογή ιστού, την εφαρμογή κινητού και τη φόρμα ιστού.
</FeatureCard>
...
>
  GitHub Issues, κοινοτικές συζητήσεις και υποστήριξη μέσω email.
</FeatureCard>
...
>
  Δείτε τον κώδικα, ανοίξτε θέματα και συνεισφέρετε.
</FeatureCard>
