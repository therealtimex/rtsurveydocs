---
title: "Wsparcie"
description: "Uzyskaj pomoc dotyczącą rtSurvey — dokumentacja, GitHub Issues i zasoby społeczności."
---
...
rtSurvey to otwartoźródłowa platforma z własnym hostingiem. Wsparcie jest świadczone za pośrednictwem GitHub i kanałów społecznościowych.
...
>
  Zgłaszaj błędy, proś o nowe funkcje lub przeglądaj znane problemy.
</FeatureCard>

<FeatureCard
  title="Dyskusje GitHub"
...
>
  Zadawaj pytania i uzyskaj pomoc od społeczności.
</FeatureCard>
...
>
  Przeglądaj pełną dokumentację rtSurvey.
</FeatureCard>
...
>
  Skontaktuj się z nami bezpośrednio pod adresem support+info@rta.vn.
</FeatureCard>

<FeatureCard
  title="Strona rtSurvey"
...
>
  Informacje o produkcie, demonstracje i zapytania korporacyjne.
</FeatureCard>
...
>
  Obserwuj @RtSurvey, aby być na bieżąco z aktualizacjami i ogłoszeniami.
</FeatureCard>

</div>

## Przed otwarciem zgłoszenia

Przed utworzeniem nowego zgłoszenia sprawdź [istniejące problemy](https://github.com/therealtimex/rtsurvey/issues). Dołącz:

- Wersję rtSurvey
- Metodę wdrożenia (Linode StackScript, DigitalOcean, ręczny Docker)
- Kroki do odtworzenia
- Odpowiednie logi (`docker compose logs`)
