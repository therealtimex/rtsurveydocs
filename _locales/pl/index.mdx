---
title: "Dokumentacja rtSurvey"
description: "Oficjalna dokumentacja rtSurvey — samodzielnie hostowana platforma do zbierania danych mobilnych i ankiet."
---

import FeatureCard from '../components/FeatureCard';

# Dokumentacja rtSurvey

Witamy w oficjalnej dokumentacji **rtSurvey** — samodzielnie hostowanej platformy do projektowania formularzy, zbierania danych w terenie i analizowania wyników w czasie rzeczywistym.
...
>
  Nowy użytkownik rtSurvey? Zacznij tutaj, aby zapoznać się z platformą.
</FeatureCard>
...
>
  Wdróż na Linode, DigitalOcean lub dowolnym serwerze Linux.
</FeatureCard>
...
>
  Twórz formularze z pytaniami, logiką, multimediami i powtórzeniami.
</FeatureCard>

<FeatureCard
  title="Interfejsy platformy"
...
>
  Poznaj aplikację webową, aplikację mobilną i formularz internetowy.
</FeatureCard>
...
>
  GitHub Issues, dyskusje społeczności i wsparcie e-mailowe.
</FeatureCard>
...
>
  Przeglądaj kod źródłowy, zgłaszaj problemy i współtwórz projekt.
</FeatureCard>
