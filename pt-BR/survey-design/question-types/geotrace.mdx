---
description: As perguntas de geotrace permitem que os respondentes capturem uma série
  de pontos conectados em um mapa, criando linhas ou caminhos como parte da pesquisa.
icon: timeline
title: Geotrace
---
