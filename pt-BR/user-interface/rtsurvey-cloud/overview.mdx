...
description: O rtCloud é o poderoso componente de servidor do rtSurvey, oferecendo
  gerenciamento de projetos, manipulação de formulários, coleta de dados e fluxos
  de trabalho avançados de envio para operações eficientes de pesquisa e estudos longitudinais.
icon: cloud
title: Visão geral
---
