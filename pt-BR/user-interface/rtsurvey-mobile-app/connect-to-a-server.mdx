---
description: Aprenda como conectar o aplicativo móvel rtSurvey ao servidor do seu
  projeto, acesse funcionalidades específicas por função e comece a colaborar em pesquisas
  em vários projetos.
icon: cloud_sync
