...
Eksempel 1:
<Callout type="info">`${age} = 3 or ${age} = 4` returnerer `sand`, hvis alderen er enten 3 eller 4.</Callout>

Eksempel 2:
<Callout type="info">`${age} > 3 and ${age} < 5` returnerer `sand`, hvis alderen er mellem 3 og 5.</Callout>

Eksempel 3:
<Callout type="info">`not(${age} > 3 and ${age} < 5)` returnerer `sand`, hvis alderen ikke er mellem 3 og 5.</Callout>
