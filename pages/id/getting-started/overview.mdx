...
rtSurvey adalah platform self-hosted untuk merancang formulir, mengumpulkan data di lapangan, dan menganalisis hasil secara real-time. Anda menjalankannya di server Anda sendiri — data Anda tidak pernah meninggalkan infrastruktur Anda.
