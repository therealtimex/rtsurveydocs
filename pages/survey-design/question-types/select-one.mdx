...
![SELECT_ONE appearance variants — label, list-nolabel, star_rating, quick, minimal, compact, rating_box, boxtag, tagging](/images/xlsform/appearance/select-one-part1.png)
...
| `search-api(...)` | Dynamic search — loads choices from Elasticsearch at runtime |
