...
![SELECT_MULTIPLE appearance variants — top, label, list-nolabel, checkall, minimal, compact, rating_box, boxtag, tagging](/images/xlsform/appearance/select-multiple-part1.png)
