...
| Provider | Guide |
|----------|-------|
| Linode (Akamai) | [Deploy on Linode](cloud-providers/linode) — easiest, form-based setup via StackScript |
| DigitalOcean | [Deploy on DigitalOcean](cloud-providers/digitalocean) |
