---
description: Dinamiskais jautājuma tips ļauj lauka jautājuma tipam un logrīkam tikt
  noteiktam izpildlaikā, pamatojoties uz API atbildi vai aprēķinātu vērtību.
icon: manage_search
