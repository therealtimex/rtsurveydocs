---
description: Uzziniet, kā savienot rtSurvey mobilo lietotni ar projekta serveri, piekļūt
  lomai specifiskajām funkcionalitātēm un sākt sadarboties aptaujās vairākos projektos.
icon: cloud_sync
