---
description: Konfigurējiet vienas pieteikšanās (SSO) pašmitinātajam rtCloud, izmantojot
  iebūvēto Keycloak, ārējo OIDC nodrošinātāju vai Azure Active Directory.
icon: lock
