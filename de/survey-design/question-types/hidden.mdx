---
description: Verborgene Felder speichern Werte, die dem Befragten nie angezeigt werden
  — sie werden verwendet, um Kontext weiterzugeben, Daten vorzubefüllen oder Zwischenergebnisse
  zu speichern.
icon: eye-slash
title: Hidden
---
