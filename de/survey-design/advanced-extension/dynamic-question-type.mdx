---
description: Der dynamische Fragetyp ermöglicht es, den Fragetyp und das Widget eines
  Feldes zur Laufzeit basierend auf einer API-Antwort oder einem berechneten Wert
  zu bestimmen.
icon: manage_search
