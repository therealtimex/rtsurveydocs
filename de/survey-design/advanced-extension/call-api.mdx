---
description: Call API ermöglicht es Ihrer Umfrage, Daten von einem externen Webdienst
  abzurufen und die Antwort zu verwenden, um Felder zu befüllen oder Antworten zu
  validieren.
icon: manage_search
