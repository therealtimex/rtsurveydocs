---
description: Webbox bettet eine externe Webseite in die Umfrage als modales iFrame
  ein, sodass Interviewer Referenzen ansehen oder mit externen Tools interagieren
  können, ohne das Formular zu verlassen.
icon: manage_search
title: Webbox
---
