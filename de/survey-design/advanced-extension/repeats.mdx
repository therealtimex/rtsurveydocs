---
description: 'Fortgeschrittene Muster für Wiederholungsgruppen: dynamische Zählung,
  verschachtelte Wiederholungen, Zusammenfassung von Wiederholungsdaten und Referenzierung
  von Werten über Wiederholungen hinweg.'
icon: manage_search
