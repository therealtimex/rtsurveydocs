---
description: Das Gitter-Layout ermöglicht die Anordnung von Feldern in einem CSS-Raster
  innerhalb einer Gruppe und ermöglicht mehrspaltiges Formulardesign.
icon: manage_search
