---
description: Die dynamische Suche lädt Auswahlmöglichkeiten in Echtzeit von einer
  Remote-API, während der Interviewer tippt, und ermöglicht so große oder häufig aktualisierte
  Datensätze.
icon: manage_search
