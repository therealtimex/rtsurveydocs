---
description: Erfahren Sie, wie Sie die mobile rtSurvey-App mit Ihrem Projekt-Server
  verbinden, auf rollenspezifische Funktionen zugreifen und über mehrere Projekte
  hinweg an Umfragen zusammenarbeiten.
icon: cloud_sync
