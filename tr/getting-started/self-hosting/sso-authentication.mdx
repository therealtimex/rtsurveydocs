---
description: Yerleşik Keycloak, harici bir OIDC sağlayıcısı veya Azure Active Directory
  kullanarak kendi barındırdığınız rtCloud için Tek Oturum Açma'yı yapılandırın.
icon: lock
