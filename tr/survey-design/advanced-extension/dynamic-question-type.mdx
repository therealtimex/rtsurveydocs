---
description: Dinamik soru türü, bir alanın soru türünün ve widget'ının form tasarım
  zamanında değil çalışma zamanında bir API yanıtına veya hesaplanmış değere göre
