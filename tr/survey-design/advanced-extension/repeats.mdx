---
description: 'Tekrar grupları için gelişmiş kalıplar: dinamik sayılar, iç içe tekrarlar,
  tekrar verilerini özetleme ve tekrarlar arasında değerlere referans verme.'
icon: manage_search
