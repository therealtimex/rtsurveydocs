---
description: Webbox, harici bir web sayfasını anket içine modal iframe olarak yerleştirir;
  sayımcıların formu terk etmeden harici araçlarla etkileşime girmesine olanak tanır.
icon: manage_search
title: Webbox
---
