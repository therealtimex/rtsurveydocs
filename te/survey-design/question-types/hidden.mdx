---
description: Hidden fields ప్రతిస్పందించే వ్యక్తికి ఎప్పటికీ చూపించబడని విలువలు నిల్వ
  చేస్తాయి — సందర్భం pass చేయడానికి, డేటా prefill చేయడానికి, లేదా intermediate results
