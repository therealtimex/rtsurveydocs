---
description: rtSurvey మొబైల్ యాప్‌ను మీ ప్రాజెక్ట్ సర్వర్‌కు ఎలా కనెక్ట్ చేయాలో నేర్చుకోండి,
  పాత్ర-నిర్దిష్ట కార్యాచరణలు యాక్సెస్ చేయండి మరియు బహుళ ప్రాజెక్టులలో సర్వేలపై సహకరించడం
  ప్రారంభించండి.
icon: cloud_sync
