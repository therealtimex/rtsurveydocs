---
description: Konfigūruokite vieningo prisijungimo (SSO) funkciją savarankiškai valdomam
  rtCloud naudodami integruotą Keycloak, išorinį OIDC teikėją arba Azure Active Directory.
icon: lock
