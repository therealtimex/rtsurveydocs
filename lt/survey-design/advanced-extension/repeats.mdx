---
description: 'Pažangūs kartojimų grupių modeliai: dinaminis skaičius, įdėtiniai kartojimai,
  kartojimų duomenų apibendrinimas ir reikšmių nuoroda per kartojimus.'
icon: manage_search
