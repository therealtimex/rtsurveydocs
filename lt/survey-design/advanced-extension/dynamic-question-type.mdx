---
description: Dinaminis klausimo tipas leidžia lauko klausimo tipui ir valdikliui būti
  nustatytam vykdymo metu pagal API atsakymą ar apskaičiuotą reikšmę.
icon: manage_search
