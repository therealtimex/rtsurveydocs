#!/bin/bash
# ==============================================================================
# rtCloud - Linode StackScript (Embedded Keycloak)
# ==============================================================================
...
# UDF - Required
# ------------------------------------------------------------------------------
# <UDF name="project_id"          label="Project ID (no spaces)"   default="rtsurvey" />
# <UDF name="keycloak_admin_password" label="Keycloak Master Admin Password (change after login)" default="admin" />
...
echo "============================================================"
echo " rtCloud StackScript (Embedded Keycloak) starting - $(date)"
echo "============================================================"
...
cat > .env << ENV_EOF
# Generated by Linode StackScript (Embedded Keycloak) on $(date)
