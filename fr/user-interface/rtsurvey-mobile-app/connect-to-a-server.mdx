---
description: Apprenez à connecter l'application mobile rtSurvey au serveur de votre
  projet, à accéder aux fonctionnalités spécifiques à votre rôle et à commencer à
  collaborer sur des enquêtes à travers plusieurs projets.
icon: cloud_sync
