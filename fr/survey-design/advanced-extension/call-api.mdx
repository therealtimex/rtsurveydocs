---
description: Call API permet à votre enquête de récupérer des données depuis un service
  web externe et d'utiliser la réponse pour peupler des champs ou valider des réponses.
icon: manage_search
title: Call API
---
