---
description: La fonctionnalité examen ajoute un mode quiz chronométré à une enquête,
  avec des retours audio optionnels pour les réponses correctes et incorrectes.
icon: manage_search
title: Examens
---
