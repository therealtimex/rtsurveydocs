---
description: La mise en page en grille vous permet de positionner les champs dans
  une grille CSS au sein d'un groupe, permettant des conceptions de formulaires multi-colonnes.
icon: manage_search
