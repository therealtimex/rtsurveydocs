---
description: Webbox intègre une page web externe dans l'enquête sous forme d'iframe
  modale, permettant aux enquêteurs de consulter des références ou d'interagir avec
  des outils externes sans quitter le formulaire.
icon: manage_search
title: Webbox
---
