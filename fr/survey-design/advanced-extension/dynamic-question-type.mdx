---
description: Le type de question dynamique permet de déterminer le type de widget
  et le comportement d'un champ au moment de l'exécution, en fonction d'une réponse
  API ou d'une valeur calculée.
icon: manage_search
