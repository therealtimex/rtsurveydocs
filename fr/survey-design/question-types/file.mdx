---
description: Les questions de type fichier permettent aux répondants de téléverser
  des documents et autres fichiers dans le cadre de leurs réponses à l'enquête.
icon: upload_file
title: File
---
