---
description: Les champs masqués stockent des valeurs qui ne sont jamais affichées
  au répondant — utilisés pour transmettre du contexte, pré-remplir des données ou
