---
description: select_one_from_file et select_multiple_from_file chargent les choix
  dynamiquement depuis un fichier CSV ou XML externe attaché au formulaire.
