...
Exemple 1 :
<Info>`${age} = 3 or ${age} = 4` retournera `true` si l'âge est 3 ou 4.</Info>

Exemple 2 :
<Info>`${age} > 3 and ${age} < 5` retournera `true` si l'âge est entre 3 et 5.</Info>

Exemple 3 :
<Info>`not(${age} > 3 and ${age} < 5)` retournera `true` si l'âge n'est pas entre 3 et 5.</Info>
