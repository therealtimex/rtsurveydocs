---
description: As perguntas geotrace permitem aos respondentes capturar uma série de
  pontos conectados num mapa, criando linhas ou percursos como parte do inquérito.
icon: timeline
title: Geotrace
---
