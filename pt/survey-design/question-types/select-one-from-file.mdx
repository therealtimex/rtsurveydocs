---
description: select_one_from_file e select_multiple_from_file carregam escolhas dinamicamente
  a partir de um ficheiro CSV ou XML externo anexado ao formulário.
