---
description: Os campos hidden armazenam valores que nunca são mostrados ao respondente
  — usados para passar contexto, pré-preencher dados ou armazenar resultados intermédios.
icon: eye-slash
title: Hidden
---
