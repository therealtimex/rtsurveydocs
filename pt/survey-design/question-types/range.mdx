---
description: As perguntas range permitem aos respondentes selecionar um número arrastando
  um controlo deslizante entre um valor mínimo e máximo definidos.
icon: sliders
title: Range
---
