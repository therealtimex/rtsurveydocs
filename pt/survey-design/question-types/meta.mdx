---
description: Os tipos de pergunta meta capturam automaticamente informações do dispositivo,
  enumerador e temporização sem qualquer entrada do respondente.
icon: info
title: Meta
---
