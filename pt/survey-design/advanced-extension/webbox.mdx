---
description: O Webbox incorpora uma página web externa dentro do inquérito como um
  iframe modal, permitindo aos enumeradores ver referências ou interagir com ferramentas
  externas sem sair do formulário.
icon: manage_search
title: Webbox
---
