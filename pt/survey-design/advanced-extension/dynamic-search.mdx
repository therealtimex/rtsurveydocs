---
description: A Pesquisa Dinâmica carrega escolhas de uma API remota em tempo real
  à medida que o enumerador escreve, permitindo conjuntos de dados grandes ou frequentemente
  atualizados.
icon: manage_search
