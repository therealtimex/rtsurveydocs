---
description: 'Padrões avançados para grupos de repetição: contagens dinâmicas, repetições
  aninhadas, resumo de dados repetidos e referência a valores entre repetições.'
icon: manage_search
