---
description: Geoshape-kysymykset antavat vastaajille mahdollisuuden piirtää muotoja
  kartalle, tallentaen monimutkaisia maantieteellisiä tietoja osana kyselyä.
icon: map
title: Geoshape
---
