---
description: select_one_from_file ja select_multiple_from_file lataavat valinnat dynaamisesti
  ulkoisesta CSV- tai XML-tiedostosta, joka on liitetty lomakkeeseen.
