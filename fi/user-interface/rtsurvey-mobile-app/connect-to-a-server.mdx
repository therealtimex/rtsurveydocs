---
description: Opi yhdistämään rtSurvey-mobiilisovellus projektipalvelimeesi, käyttämään
  roolipohjaisia toimintoja ja aloittamaan yhteistyö useissa projekteissa.
icon: cloud_sync
