---
description: Preskúmajte kľúčové funkcie mobilnej aplikácie rtSurvey vrátane vyplňovania
  formulárov, úprav, odosielania, oznámení, správy úloh, reportovania a GPS mapovania
icon: apps
