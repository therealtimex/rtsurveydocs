---
description: Konfigurácia Single Sign-On pre vlastný hosting rtCloud pomocou vstavaného
  Keycloak, externého poskytovateľa OIDC alebo Azure Active Directory.
icon: lock
