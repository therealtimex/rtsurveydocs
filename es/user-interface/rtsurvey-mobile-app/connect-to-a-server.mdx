---
description: Aprenda a conectar la aplicación móvil rtSurvey a su servidor de proyecto,
  acceder a funcionalidades específicas por rol y comenzar a colaborar en encuestas
