---
description: Webbox incrusta una página web externa dentro de la encuesta como un
  iframe modal, permitiendo a los encuestadores ver referencias o interactuar con
  herramientas externas sin salir del formulario.
icon: manage_search
title: Webbox
---
