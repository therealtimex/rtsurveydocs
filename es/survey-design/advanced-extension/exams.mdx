---
description: La función de examen agrega un modo de cuestionario cronometrado a una
  encuesta, con retroalimentación de audio opcional para respuestas correctas e incorrectas.
icon: manage_search
title: Exámenes
---
