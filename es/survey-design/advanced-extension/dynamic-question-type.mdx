---
description: El tipo de pregunta dinámico permite que el tipo de pregunta y el widget
  de un campo se determinen en tiempo de ejecución según una respuesta de API o un
  valor calculado.
icon: manage_search
