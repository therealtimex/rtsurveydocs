---
description: 'Patrones avanzados para grupos de repetición: conteos dinámicos, repeticiones
  anidadas, resumen de datos de repetición y referencia de valores entre repeticiones.'
icon: manage_search
