---
description: Los tipos de pregunta meta capturan automáticamente información del dispositivo,
  del encuestador y de tiempo sin ninguna entrada del encuestado.
icon: info
title: Meta
---
