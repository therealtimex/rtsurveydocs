---
description: Las preguntas de rango permiten a los encuestados seleccionar un número
  arrastrando un control deslizante entre un valor mínimo y máximo definido.
icon: sliders
title: Rango
---
