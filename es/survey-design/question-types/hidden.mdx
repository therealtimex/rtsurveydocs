---
description: Los campos ocultos almacenan valores que nunca se muestran al encuestado
  — se usan para pasar contexto, precargar datos o almacenar resultados intermedios.
icon: eye-slash
title: Oculto
---
