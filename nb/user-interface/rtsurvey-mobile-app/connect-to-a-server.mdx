---
description: Lær hvordan du kobler rtSurvey-mobilappen til prosjektserveren din, får
  tilgang til rollebaserte funksjoner og begynner å samarbeide om undersøkelser på
  tvers av flere prosjekter.
icon: cloud_sync
