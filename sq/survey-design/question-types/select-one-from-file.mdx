---
description: select_one_from_file dhe select_multiple_from_file ngarkojnë zgjedhjet
  dinamikisht nga një skedar i jashtëm CSV ose XML i bashkangjitur formulares.
