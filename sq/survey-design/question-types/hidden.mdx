---
description: Fushat e fshehura ruajnë vlera që nuk shfaqen kurrë te i anketuari —
  përdoren për të kaluar kontekst, parapredisur të dhëna, ose ruajtur rezultate ndërmjetëse.
icon: eye-slash
title: Hidden
---
