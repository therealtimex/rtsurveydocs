---
description: Lloji dinamik i pyetjes lejon llojin e widget-it dhe sjelljen e validimit
  të fushës të përcaktohen gjatë ekzekutimit bazuar në përgjigjen e API ose vlerën
  e llogaritur.
icon: manage_search
