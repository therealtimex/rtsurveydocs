---
description: Kërkimi dinamik ngarkon zgjedhjet nga API në distancë në kohë reale ndërsa
  numëruesi shkruan, duke mundësuar bashkësi të dhënash të mëdha ose të përditësuara
  shpesh.
icon: manage_search
