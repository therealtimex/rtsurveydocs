---
description: A select_multiple kérdések lehetővé teszik a válaszadók számára, hogy
  egy vagy több lehetőséget válasszanak egy előre meghatározott listából.
icon: check_box
