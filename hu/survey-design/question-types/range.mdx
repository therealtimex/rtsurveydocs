---
description: A range kérdések lehetővé teszik a válaszadók számára, hogy egy számot
  válasszanak egy csúszka húzásával a meghatározott minimális és maximális érték között.
icon: sliders
title: Range
---
