---
description: A meta kérdéstípusok automatikusan rögzítik az eszközzel, a kérdezőbiztossal
  és az időzítéssel kapcsolatos információkat a válaszadó közreműködése nélkül.
icon: info
title: Meta
---
