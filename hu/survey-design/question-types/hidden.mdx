---
description: A hidden mezők olyan értékeket tárolnak, amelyeket soha nem mutatnak
  a válaszadónak – kontextus átadására, adatok előre kitöltésére vagy közbülső eredmények
