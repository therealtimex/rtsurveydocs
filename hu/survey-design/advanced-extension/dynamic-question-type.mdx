---
description: A dinamikus kérdéstípus lehetővé teszi, hogy egy mező kérdéstípusát és
  widgetjét futásidőben határozza meg egy API-válasz vagy számított érték alapján.
icon: manage_search
