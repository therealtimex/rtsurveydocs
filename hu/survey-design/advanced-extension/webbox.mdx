---
description: A Webbox beágyaz egy külső weblapot a felmérésbe modális iframeként,
  lehetővé téve a kérdezők számára, hogy megtekinthessék a hivatkozásokat vagy interakcióba
  léphessenek külső eszközökkel anélkül, hogy elhagynák az űrlapot.
icon: manage_search
title: Webbox
---
