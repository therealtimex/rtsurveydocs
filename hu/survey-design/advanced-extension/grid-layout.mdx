---
description: A rácsszerű elrendezés lehetővé teszi a mezők CSS-rácsban való elhelyezését
  egy csoporton belül, így többoszlopos űrlapkialakítást tesz lehetővé.
icon: manage_search
