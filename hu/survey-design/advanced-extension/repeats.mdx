---
description: 'Haladó minták ismétlőcsoportokhoz: dinamikus számok, beágyazott ismétlések,
  ismétlési adatok összefoglalása és értékek hivatkozása ismétlések között.'
icon: manage_search
