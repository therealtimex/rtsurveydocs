---
description: Egyszeri bejelentkezés (SSO) konfigurálása saját üzemeltetésű rtCloud-hoz
  beágyazott Keycloak, külső OIDC-szolgáltató vagy Azure Active Directory segítségével.
icon: lock
