---
description: Tudja meg, hogyan csatlakoztathatja az rtSurvey mobilalkalmazást a projekt
  kiszolgálójához, érheti el a szerepkörspecifikus funkciókat, és kezdhet el együttműködni
  több projekten végzett felméréseken.
icon: cloud_sync
