---
description: 'Avanserte mønstre for repeat-grupper: dynamiske antall, nestede repeats,
  sammendrag av repeat-data og referering til verdier på tvers av repeats.'
icon: manage_search
