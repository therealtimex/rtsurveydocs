---
description: Dynamisk søk laster alternativer fra et eksternt API i sanntid mens telleren
  skriver, noe som muliggjør store eller hyppig oppdaterte datasett.
icon: manage_search
title: Dynamisk søk
---
