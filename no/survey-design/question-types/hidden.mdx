---
description: Skjulte felt lagrer verdier som aldri vises for respondenten — brukes
  til å sende kontekst, forhåndsutfylle data eller lagre mellomliggende resultater.
icon: eye-slash
title: Skjult
---
