---
description: rtCloud er den kraftige serverkomponenten til rtSurvey, og tilbyr prosjektstyring,
  skjemahåndtering, datainnsamling og avanserte innsendingsarbeidsflyter for effektive
  undersøkelsesoperasjoner og longitudinelle studier.
icon: cloud
title: Oversikt
---


![rtCloud-hjemmeside](/images/rtsurvey-cloud-home.webp)
