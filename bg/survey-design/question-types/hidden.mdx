---
description: Скритите полета съхраняват стойности, които никога не се показват на
  респондента — използват се за предаване на контекст, предварително попълване на
  данни или съхранение на междинни резултати.
icon: eye-slash
title: Скрито поле
---
