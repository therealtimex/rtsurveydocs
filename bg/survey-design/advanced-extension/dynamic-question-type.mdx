---
description: Динамичният тип въпрос позволява типът въпрос и уиджетът на поле да се
  определят по времe на изпълнение въз основа на API отговор или изчислена стойност.
icon: manage_search
