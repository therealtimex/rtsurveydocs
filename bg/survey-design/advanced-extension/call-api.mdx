---
description: Функцията Call API позволява на анкетата ви да извлича данни от zewnętrzна
  уеб услуга и да използва отговора за попълване на полета или валидиране на отговори.
icon: manage_search
