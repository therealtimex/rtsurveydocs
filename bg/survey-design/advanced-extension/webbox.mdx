---
description: Webbox вгражда zewnętrzна уеб страница вътре в анкетата като модален
  iframe, позволявайки на анкетьорите да преглеждат справки или да взаимодействат
  с外部 инструменти без да напускат формуляра.
icon: manage_search
title: Webbox
---
