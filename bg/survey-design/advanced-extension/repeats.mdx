---
description: 'Разширени модели за групи за повторение: динамични броячи, вложени повторения,
  обобщаване на данни от повторения и препратка към стойности в рамките на повторения.'
icon: manage_search
