---
description: 'Avancerede mønstre for gentagelsesgrupper: dynamiske antal, indlejrede
  gentagelser, opsummering af gentagelsesdata og krydsreferencer mellem gentagelser.'
icon: manage_search
