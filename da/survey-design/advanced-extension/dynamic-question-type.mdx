---
description: Dynamisk spørgsmålstype giver mulighed for at bestemme et felts spørgsmålstype
  og widget ved kørselstid baseret på et API-svar eller en beregnet værdi.
icon: manage_search
