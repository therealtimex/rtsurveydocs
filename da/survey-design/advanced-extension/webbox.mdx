---
description: Webbox indlejrer en ekstern webside inde i undersøgelsen som en modal
  iframe, der giver interviewere mulighed for at se referencer eller interagere med
  eksterne værktøjer uden at forlade formularen.
icon: manage_search
title: Webbox
---
