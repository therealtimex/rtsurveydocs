---
description: Geoshape-spørgsmål giver respondenter mulighed for at tegne former på
  et kort og fange komplekse geografiske data som en del af undersøgelsen.
icon: map
title: Geoshape
---
