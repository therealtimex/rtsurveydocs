---
description: Налаштуйте єдиний вхід (SSO) для самостійного rtCloud за допомогою вбудованого
  Keycloak, зовнішнього постачальника OIDC або Azure Active Directory.
icon: lock
