---
description: Tìm hiểu cách kết nối ứng dụng di động rtSurvey với máy chủ dự án của
  bạn, truy cập các chức năng theo vai trò cụ thể và bắt đầu cộng tác trên các khảo
  sát trong nhiều dự án.
icon: cloud_sync
