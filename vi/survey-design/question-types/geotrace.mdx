---
description: Các câu hỏi kiểu Geotrace cho phép người trả lời ghi lại một chuỗi các
  điểm được kết nối trên bản đồ, tạo thành các đường hoặc lối đi như một phần của
  cuộc khảo sát.
icon: timeline
