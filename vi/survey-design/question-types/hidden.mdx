---
description: Trường hidden lưu trữ các giá trị không bao giờ được hiển thị cho người
  trả lời — dùng để truyền ngữ cảnh, điền sẵn dữ liệu hoặc lưu kết quả trung gian.
icon: eye-slash
title: Hidden
---
