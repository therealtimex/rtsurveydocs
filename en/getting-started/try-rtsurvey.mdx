---
description: Experience rtSurvey's CAPI system through five role-specific demo accounts,
  allowing users to explore functionalities for administrators, project managers,
  survey designers, field enumerators, and data analysts within a simulated survey
  project environment.
icon: rocket_launch
title: Try rtSurvey
---
