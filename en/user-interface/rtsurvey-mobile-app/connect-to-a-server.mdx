---
description: Learn how to connect the rtSurvey mobile app to your project server,
  access role-specific functionalities, and start collaborating on surveys across
  multiple projects.
icon: cloud_sync
