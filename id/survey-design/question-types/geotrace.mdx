---
description: Pertanyaan geotrace memungkinkan responden menangkap serangkaian titik
  yang terhubung pada peta, membuat garis atau jalur sebagai bagian dari survei.
icon: timeline
title: Geotrace
---
