---
description: Pelajari cara menghubungkan aplikasi mobile rtSurvey ke server proyek
  Anda, mengakses fungsionalitas khusus peran, dan mulai berkolaborasi dalam survei
  di beberapa proyek.
icon: cloud_sync
