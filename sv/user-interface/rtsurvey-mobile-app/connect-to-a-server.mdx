---
description: Lär dig hur du ansluter rtSurvey-mobilappen till din projektserver, kommer
  åt rollspecifika funktioner och börjar samarbeta om undersökningar i flera projekt.
icon: cloud_sync
