---
description: Webbox bäddar in en extern webbsida inuti undersökningen som ett modalt
  iframe-fönster, vilket gör det möjligt för räknare att se referenser eller interagera
  med externa verktyg utan att lämna formuläret.
icon: manage_search
title: Webbox
---
