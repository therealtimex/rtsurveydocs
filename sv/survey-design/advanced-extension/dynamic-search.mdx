---
description: Dynamisk sökning laddar alternativ från ett fjärr-API i realtid när räknaren
  skriver, vilket möjliggör stora eller ofta uppdaterade datamängder.
icon: manage_search
