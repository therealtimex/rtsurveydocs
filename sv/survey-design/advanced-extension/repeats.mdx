---
description: 'Avancerade mönster för upprepningsgrupper: dynamiska antal, kapslade
  upprepningar, sammanfattning av upprepningsdata och referering till värden mellan
  upprepningar.'
icon: manage_search
